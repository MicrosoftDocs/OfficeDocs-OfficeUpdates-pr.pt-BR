...
## <a name="may-10-2021"></a>10 de maio de 2021
Versão 16.0.13929.20296 (setup.exe versão 16.0.13929.20238)
- Corrigido um problema em que o /modo de configuração poderia falhar se um arquivo de configuração incluir o MigrateArch e o RemoveMSI
- Melhorias adicionais de confiabilidade
...
- Mudanças para oferecer suporte aos próximos lançamentos de produtos do Office
- Correções de confiabilidade para plataformas ARM


## <a name="february-25-2021"></a>25 de fevereiro de 2021
Versão 16.0.13628.20476 (setup.exe versão 16.0.13628.20462)
- Corrigido um problema em que os arquivos configuration.xml que especificam vários idiomas não eram validados
- Corrigido um problema em que a propriedade FORCEAPPSHUTDOWN não era respeitada em cenários MigrateArch
- Corrigido um problema em que a especificação de dois ou mais atributos PIDKEY em configuration.xml falhou ao instalar os PIDKeys
...
- Adiciona suporte para controlar opcionalmente a implantação inicial do [recurso Pesquisa da Microsoft no Bing](/deployoffice/microsoft-search-bing)
