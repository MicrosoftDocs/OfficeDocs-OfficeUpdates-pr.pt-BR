...
- Corrigido o problema em que os cartões de comentários ao lado da tela do Word tinham o tamanho incorreto.
...
## <a name="version-2106-june-25"></a>Versão 2106: 25 de junho
*Versão 2106 (Build 14131.20250)*
...
## <a name="version-2106-june-21"></a>Versão 2106: 21 de junho
*Versão 2106 (Build 14131.20194)*
...
- **Leia mensagens com menos distrações:** torne mais fácil se concentrar em mensagens com espaçamento de texto, cores de página, largura de coluna e foco de linha personalizados, ativando o Leitura Avançada.
...
## <a name="version-2106-june-14"></a>Versão 2106: 14 de junho
*Versão 2106 (Build 14131.20162)*
...
## <a name="version-2106-june-07"></a>Versão 2106: 07 de junho
*Versão 2106 (Build 14131.20012)*
...
- Corrigimos um problema em que o modo Sobrescrever do IME não estava digitando sobre os caracteres, ele os deixava no final da cadeia de caracteres.
...
- Corrigimos um problema que causava um encerramento inesperado para alguns usuários ao carregar cartões de pessoas.
...
- Corrigimos um problema que fazia com que os usuários vissem cópias de todos os itens enviados aparecendo na pasta Caixa de Saída.
...
- Corrigimos um problema que causava um fechamento inesperado ao usar o programa Ler em Voz Alta com outras versões do Windows.


- Corrigimos um problema que causava um travamento para os usuários ao remover pastas de um armazenamento de arquivo morto.


- Corrigimos um problema que causava um encerramento para alguns usuários ao carregar cartões de pessoas.
...
- Corrigimos um problema que garante que um arquivo salvo usando o botão 'Repetir Salvar' na barra de barramento seja adicionado à Lista Recente.
...
- Corrige um problema em que um comentário fica temporariamente em branco após a postagem.
...
- Corrigimos um problema em que o painel Comentários fechava inesperadamente.


- Corrigimos um problema em que os comentários não eram realçados quando selecionados.
...
- Corrigimos um problema em que os cartões contextuais de tela para ortografia e gramática mostram botões de ícones, mas esses botões não têm dicas de ferramentas.
...
- Corrigimos um problema em que textos sublinhados de similaridade não desaparecem ao alternar para a categoria Ortografia no Editor. 


- Corrigimos um problema em que o Word ocasionalmente exibia uma borda em volta do texto que não deveria estar lá.


- Corrigimos um problema em que o espaçamento entre caracteres aumentava para fontes específicas ao girá-las em 90 graus.
...
- Corrigimos um problema em que às vezes as respostas aos comentários eram perdidas durante a coautoria com vários usuários.
...
- Corrigimos um problema em que o recurso CLP anteriormente causava salvamentos não solicitados no arquivo SyncBacked (Arquivo sincronizado pelo OneDrive).


- Corrigimos um problema em que o usuário não conseguia editar arquivos armazenados nos servidores OnPrem.


- Corrigimos uma regressão de desempenho ao abrir arquivos SyncBacked.
...
## <a name="version-2105-june-04"></a>Versão 2105: 4 de Junho
*Versão 2105 (Build 14026.20264)*
...
- **Configurações de detecção de tipo de dados:** configure o comportamento de detecção de tipo de dados ao importar dados de fontes não estruturadas com o Power Query no Excel

### <a name="word"></a>Word

- **Estilos de Redação:** Estilos de Redação seleciona críticas com base no nível de formalidade selecionado pelo usuário
...
- **Apresentando layouts para reuniões do Teams:** Agora você pode aparecer sobreposto no topo do conteúdo para uma apresentação mais envolvente e uma experiência de consumo
...
- **Gerenciar marcas no Teams programaticamente - As APIs de Marcas do Microsoft Teams agora estão em visualização pública:** Este conjunto de APIs pode ser utilizado para atribuir marcas aos usuários de maneira programática em uma equipe, tornando a criação e manutenção de marcas mais rápida e fácil.  As marcas no Teams permitem que os usuários alcancem rapidamente um grupo de pessoas sem ter que @mencionar ou digitar todos. Para obter mais informações sobre marcas no Teams, consulte Usando marcas no Teams. Usando estas novas APIs, os desenvolvedores podem agora Criar marcas em uma equipe e designar usuários, Obter uma lista de marcas em uma equipe, Atualizar marcas e Excluir marcas
...
- Corrigimos um problema em que alguns arquivos ocasionalmente não estavam abrindo no Modo de Exibição Protegido
...
- Corrigimos um problema de coautoria com arquivos protegidos por DRM
...
## <a name="version-2101-february-02"></a>Versão 2101: 02 de fevereiro
*Versão 2101 (Build 13628.20320)*
...
## <a name="version-2101-january-25"></a>Versão2101: 25 de janeiro
...
## <a name="version-2012-december-14"></a>Versão 2012: 14 de dezembro
*Versão 2012 (Build 13530.20144)*
...
- **As configurações do Outlook na nuvem:** escolha as configurações do Outlook para Windows, como respostas automáticas, caixa de entrada prioritária e privacidade, e acesse-as em qualquer computador.
...
## <a name="version-2012-december-07"></a>Versão 2012: 07 de dezembro
*Versão 2012 (Build 13530.20064)*
...
- **As notificações nativas do Windows agora têm suporte no Teams:** Os usuários agora podem selecionar seus meios preferenciais de entrega de notificação, seja por meio de faixas internas do Teams ou faixas nativas do Windows.


- **Reuniões do Teams modo de exibição de galeria 2x2 no Citrix e no VMWare VDI:** O recurso Teams no modo de exibição de galeria 2x2 no VDI será habilitado para exibir até quatro vídeos de participantes no Modo de Exibição de Galeria 2x2 em clientes da VDI da Citrix, VMWare quando o cliente Teams estiver no modo optimizado VDI.


- **Reações de Reunião:**  As reações de reunião são uma nova maneira de interagir em reuniões. Os participantes podem enviar reações que são mostradas como um fluxo no conteúdo que está sendo compartilhado e, na pessoa que enviou a reação, se elas forem exibidas no palco da estágio. 


- **Modo Juntos e Galeria Grande para Reuniões da Web** A Galeria Grande permite que você veja os vídeos de até 49 outras pessoas ao mesmo tempo. Essa opção está disponível quando pelo menos dez pessoas têm suas câmeras ativadas. O modo Juntos permite que você se sinta como se estivesse no mesmo espaço junto com todos na reunião. O modo Juntos está disponível quando há pelo menos cinco pessoas na reunião. 


- **Mescla de chamadas** A Mescla de Chamadas permite que os usuários mesclem uma nova chamada que eles façam ou uma nova chamada recebida, em suas chamadas individuais ou de grupo. Isso se aplica a chamadas de VOIP e chamadas PSTN no Teams. 
...
- Correção de um problema em que a edição em idiomas que exigem o uso de IME iria se comportar mal ao editar no modo de substituição.


- Correção de um problema em que alguns usuários veriam incorretamente uma barra de mensagens informando-os de uma nova versão de um arquivo durante a co-autoria.


- Correção de um problema em que o Excel fecharia inesperadamente ao copiar e colar dados no modo de fórmula.


- Corrigido um hiperlink quebrado para um artigo de ajuda em um alerta, caso o Salvamento Automático fique desabilitado.


- Corrigimos um problema em que, ao inserir dados enquanto o Excel é executado em determinados idiomas podem fazer com que o Excel pare de funcionar.


- Essa alteração resolve um problema com a exibição adequada de fontes em equações.


- Isso corrige um problema em que o Power Pivot não pôde importar corretamente um arquivo de texto delimitado por tabulação.
...
- Corrigimos um problema que estava fazendo com que os usuários experimentassem alguns problemas ao enviar emails do Outlook de aplicativos diferentes do Outlook.
...
- Essa alteração resolve um problema relacionado a tempos limites que ocorrem durante a análise de tinta.
...
- Corrigimos um problema em que um indicador de presença de co-autoria desconhecida não é atualizado completamente quando mais informações sobre o co-autor está disponível.


- Correção de um ponteiro null que está sendo cancelado quando o modo de exibição de slides é redimensionado com a régua ativada.
...
- Correção de um problema em que abrir um projeto com muitos recursos estava levando muito tempo.


- Corrigido problema em que os usuários podem ver várias atribuições não atribuídas associadas a uma tarefa.
...
- Colar como texto sem formatação é geralmente preferível comparado a colar como rich text. Este correção de menu de contexto permite que o usuário cole como texto sem formatação. Senão, o usuário teria que copiar em um editor de texto simples, como o Bloco de Notas, e, em seguida, copiar do Bloco de Notas para o aplicativo de destino desejado
...
## <a name="version-2011-december-01"></a>Versão 2011: 01 de dezembro
*Versão 2011 (Build 13426.20306)*
...
- **Todas as reuniões online:** Facilite o agendamento de reuniões online com uma nova configuração para tornar todas as reuniões online por padrão.
...
## <a name="version-2010-november-04"></a>Versão 2010: 04 de novembro
*Versão 2010 (Build 13328.20340)*
...
- Consertamos um problema que fazia com que o Outlook criasse uma segunda assinatura vazia para as pessoas com as configurações de nuvem habilitadas.
...
## <a name="version-2009-september-21"></a>Versão 2009: 21 de setembro
*Versão 2009 (Build 13231.20200)*
...
## <a name="version-2009-september-14"></a>Versão 2009: 14 de setembro
*Versão 2009 (Build 13231.20152)*
* Várias correções de bugs e de desempenho.
...
- Tratamos de um problema que fazia com que as reuniões não fossem retiradas do calendário de um gerente, quando recusadas por um representante em algumas circunstâncias.
...
- Tratamos de um problema que fazia com que o menu de contexto do botão direito do mouse não fosse exibido nos controles de pesquisa.
...
## <a name="version-2007-july-27"></a>Versão 2007: 27 de Julho
*Versão 2007 (Compilação 13029.20292)*
* Várias correções de bugs e desempenho.

## <a name="version-2007-july-20"></a>Versão 2007: Julho 20
*Versão 2007 (Compilação 13029.20236)*
* Várias correções de bugs e desempenho.
