...
- Corrigimos um problema em que um arquivo vinculado ao PowerPoint ficava indisponível quando o arquivo .xlsx de origem já estava sendo executado em tela de fundo e ambos os arquivos eram abertos na pasta ODB local sincronizada.


- Corrigimos um problema em que nomes de função localizados agora são reconhecidos ao abrir arquivos CSV.


### <a name="word"></a>Word

- Corrigimos um problema relacionado ao tamanho da impressão ser muito pequeno no Word Mobile.


- Corrigimos um problema em que um arquivo adicionado a uma biblioteca de documentos do Microsoft Office SharePoint Online herdaria a configuração "Mostrar painel de informações do documento" imediatamente após a abertura e permaneceria se o arquivo fosse removido do Microsoft Office SharePoint Online.


- Corrigimos um problema em que um nome de pasta que não terminava com "/" era interpretado incorretamente pelo analisador de URL.


### <a name="office-suite"></a>Pacote do Office

- Corrigimos um problema em que as propriedades do DropShadow adicionadas na caixa de pesquisa tornavam a TitleBar muito alta, criando bugs de layout.
...
- Corrigimos um problema que fazia o Outlook fechar inesperadamente ao usar o programa Ler em Voz Alta com outras versões do Windows.


### <a name="word"></a>Word

- Corrigimos um problema que fazia o Word fechar inesperadamente ao usar o programa Ler em Voz Alta com outras versões do Windows.
...
- Corrigimos um problema em que o texto reservado seria cortado nos comentários ao usar idiomas da direita para a esquerda.


### <a name="office-suite"></a>Pacote do Office

- Corrigimos um problema em que hiperlinks, incluindo dígitos, seriam quebrados ao compor uma mensagem no Outlook em um idioma da direita para a esquerda.
...
## <a name="version-2105-april-16"></a>Versão 2105: 16 de abril
*Versão 2105 (Build 14007.20002)*
...
- Corrigimos um problema que fazia com que o Excel travasse ao usar o Office de 32 bits no Windows de 64 bits.
...
- **Inserir vídeos da Flipgrid no PowerPoint:** o PowerPoint agora terá suporte para a inserção de vídeos do Flipgrid nos slides.
...
- Corrigimos um problema com comentários durante a coautor.
...
- Corrige um problema em que o Excel poderia falhar ao iniciar ou fechar inesperadamente se certas configurações de proteção contra exploração de Segurança do Windows (SimExec, CallerCheck) estiverem em uso.
...
- Isso corrige um problema que impedia que a digitação e a presença em tempo real fosse restaurada após perder a conectividade com a Internet por um período de tempo.


- Corrigimos um problema com a coautoria.



[//]: # (NÃO REMOVA O FIM DO CONTEÚDO DE DETALHES DO BUG)

## <a name="version-2102-january-15"></a>Versão 2102: 15 de janeiro
*Versão 2102 (Build 13707.20008)*
...
- **Compartilhar com o Teams:** compartilhar um email ou uma conversa do Outlook com uma pessoa ou canal no Teams.

### <a name="visio"></a>Visio

- **Gráficos prontos para seus diagramas:** escolha entre uma grande biblioteca de ícones, fotos de catálogo, pessoas removidas da imagem e figurinhas que você pode adicionar aos seus desenhos do Visio. [Saiba mais](https://support.office.com/article/0ab844a5-289b-47f2-ba92-eeda168bc381)
...
- Correção de uma falha ao executar a macro VBA, ExportAsFixedFormat2 falha com um erro informando “Valor ilegal de apresentação (membro desconhecido)”.



[//]: # (NÃO REMOVA O FIM DO CONTEÚDO DOS DETALHES DO BUG)

## <a name="version-2102-january-08"></a>Versão 2102: 08 de janeiro
*Versão 2102 (Compilação 13704.20000)*
...
- **O ditado ficou ainda melhor:** Agora é mais fácil criar conteúdo com sua voz com a nova barra de ferramentas de ditado, comandos de voz e suporte de pontuação automática
...
- Corrigido um problema em que o indicador de presença de um coautoria desconhecido não é totalmente atualizado, uma vez que mais informações sobre o coautoria estão disponíveis.
...
- Corrigimos um problema em que a troca 'automática' entre janelas de formulário estava mudando para outro formulário.
...
## <a name="version-2011-october-16"></a>Versão 2011: 16 de outubro
*Versão 2011 (Build 13408.20000)*
...
- Consertamos um problema em que os usuários não conseguiram excluir os compromissos no Calendário dos grupos do Microsoft 365 na autenticação básica.
...
- Consertamos um problema em que o ícone do espaço reservado para conteúdo ao lado de imagens não tinha dica de ferramenta.


- Consertamos um problema em que o modo de exibição de apresentação de slides, mostrado pelo arquivo pptsx, permite a captura de tela do documento protegido por IRM.
...
*Versão 2006 (Compilação 12920.20000)*
