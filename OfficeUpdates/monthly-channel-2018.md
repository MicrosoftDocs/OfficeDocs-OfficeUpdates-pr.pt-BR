...
-   Corrigido o problema de símbolos no intervalo 2190...2194 alterados para Cambria Math. Isso faz com que a altura de célula do Excel aumente 3 vezes.
-   Isso corrige o problema em que o Excel pode não responder quando o usuário passa o mouse sobre opções de formatação em uma pasta de trabalho com muitos nomes definidos, e em que o Excel pode não responder na ferramenta Análise Rápida, mesmo que a Visualização Dinâmica esteja desabilitada em opções.
-   Estamos investigando o desempenho lento ao mover a janela do aplicativo do Excel de uma área de trabalho para outra. Enquanto isso, se você notar essa lentidão uma solução alternativa é selecionar "Otimizar para compatibilidade" para "Quando usar exibições múltiplas" na guia "Geral" na caixa de diálogo Opções do Arquivo.

### <a name="powerpoint-non-security-updates"></a>PowerPoint: Atualizações não relacionadas à segurança
-   Corrigido um problema de corrupções potenciais ao salvar arquivos com conteúdo ActiveX.

### <a name="word-non-security-updates"></a>Word: Atualizações não relacionadas à segurança
-   Corrigido o problema do aparecimento do editor de equações, ao inserir um objeto de Documento do Word.

### <a name="project-non-security-updates"></a>Project: Atualizações não relacionadas à segurança
-   Corrigido um problema em que, se você definisse um cabeçalho ou rodapé para uma impressão, a alteração não persistia até a próxima vez que fosse imprimir seu projeto.
...
### <a name="access-feature-updates"></a>Access: atualização de recursos
 - **Atualizar, vincular novamente ou remover tabelas vinculadas** O Gerenciador de Tabelas Vinculadas atualizado é o local para o gerenciamento de todas as fontes de dados e tabelas vinculadas. [Saiba mais](https://support.office.com/article/1d9346d6-953d-4f85-a9ce-4caec2262797)

### <a name="outlook-feature-updates"></a>Outlook: atualização de recursos
 - **Desativar o encaminhamento de uma reunião** Impede que os participantes encaminhem sua reunião para outras pessoas. Vá para a faixa de opções e clique em Opções de resposta. [Saiba mais](https://support.office.com/article/5C9877BC-AB91-4A7C-99FB-B0B68D7EA94F)
...
### <a name="word-feature-updates"></a>Word: atualizações de recursos
 - **Controle alterações com o IRM:** agora você pode usar o recurso Controlar alterações no Word em documentos protegidos por IRM sem a necessidade de direito de uso de Controle Total.
...
### <a name="office-suite-non-security-updates"></a>Pacote do Office: atualizações não relacionadas à segurança
 - Corrige alguns problemas de desempenho.
...
### <a name="outlook-non-security-updates"></a>Outlook: atualizações não relacionadas à segurança
 - Correção de um problema em que, ao chamar a API MAPI, o aplicativo podia falhar.
...
### <a name="outlook-non-security-updates"></a>Outlook: atualizações não relacionadas à segurança
 - Correção de um problema em que o Outlook travava ao usar o suplemento do iCloud.
...
### <a name="access-feature-updates"></a>Access: atualizações de recursos
 - **Visualize dados com gráficos novos:** escolha entre 11 gráficos e adicione um deles aos formulários e relatórios para visualizar melhor os dados e tomar decisões informadas. [Saiba mais](https://support.office.com/article/1a463106-65d0-4dbb-9d66-4ecb737ea7f7)
...
### <a name="project-non-security-updates"></a>Project: atualizações não relacionadas à segurança
 - Corrige um problema em que o Project podia falhar na primeira vez que você salvasse um projeto no Project Web App.


### <a name="visio-feature-updates"></a>Visio: atualizações de recursos
 - **Iniciador de diagramas:** os modelos de Organograma, Debate e SDL têm novos iniciadores de diagramas para você começar a trabalhar rapidamente.
...
-   **Nunca mais perca um lembrete:** defina lembretes a serem exibidos sobre as janelas nas quais você está trabalhando. Caso contrário, o Outlook pisca na barra de tarefas para chamar a sua atenção.[Saiba mais](https://support.office.com/article/7a992377-ca93-4ddd-a711-851ef3597925)
...
### <a name="project-feature-updates"></a>Project: atualizações de recursos
-   **Filtragem do painel de tarefas:** simplifique seus painéis de tarefas filtrando os principais recursos ou tarefas de resumo.
...
### <a name="word-feature-updates"></a>Word: atualizações de recursos
-   **Localize e corrija problemas relevantes de revisão de texto:** agora o painel do Editor exibe uma visão geral dos problemas de revisão de texto encontrados no documento, assim o foco fica na correção daqueles que são relevantes para você.
...
-   Correção de um problema em que o OneDrive for Business (Groove.exe) consumia um núcleo dos núcleos da CPU (por exemplo, 25% em uma CPU de 4 núcleos) no Gerenciador de Tarefas por longos períodos de tempo.
...
### <a name="project-non-security-updates"></a>Project: atualizações não relacionadas à segurança
-   Correção de um problema em que, ao definir mais de uma linha de base em uma sessão, o valor MOD\_DATE era definido como o mesmo.

### <a name="skype-for-business-non-security-updates"></a>Skype for Business: atualizações não relacionadas à segurança
-   Correção de um problema em que o local era preenchido, mesmo quando UseLocationForE911Only estava definido como verdadeiro.
...
### <a name="excel-non-security-updates"></a>Excel: atualizações não relacionadas à segurança
-   Correção de um problema em que, se o idioma de edição fosse o japonês, chinês ou coreano, o Excel congelava quando você tentava escolher uma nova fonte na guia Página Inicial ou editar.
...
-   **Anule a seleção de células:** faça seleções na planilha e anule a seleção de células clicadas acidentalmente sem ter que começar tudo do início.

### <a name="excel-non-security-updates"></a>Excel: atualizações não relacionadas à segurança
-   Correção de um problema em que as referências da pasta de trabalho falhava ao abrir várias pastas de trabalho clicando nos nomes dos arquivos no Explorador de Arquivos.
...
-   Correção de um problema em que, quando a política EnableExternalP2PFileTransfer estava definida como false, os usuários ainda podiam anexar arquivos em reuniões.
...
### <a name="excel-non-security-updates"></a>Excel: atualizações não relacionadas à segurança
-   Correção de um problema em que a criação programática de uma Tabela Dinâmica seguida de uma atualização programática causava uma falha no Excel.
-   Correção de um problema em que chamar programaticamente o Workbook.Open() pode levar a uma falha no Excel.

### <a name="powerpoint-non-security-updates"></a>PowerPoint: atualizações não relacionadas à segurança
-   Correção de um problema em que remover propriedades do documento e informações pessoais poderiam causar uma falha no salvamento do SharePoint.
