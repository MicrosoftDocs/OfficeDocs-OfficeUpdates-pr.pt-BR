...
---
# <a name="release-notes-for-semi-annual-channel-targeted-releases-in-2016"></a>Notas de versão para Semi-Annual lançamentos do Canal Semes que foram lançados em 2016

Essas notas de versão fornecem informações sobre novos recursos, atualizações de segurança e atualizações que não são de segurança incluídas nas atualizações do Canal Semi-Annual (Direcionado) para o Office 365 ProPlus em 2016.
...
> - Semi-Annual Channel (Direcionado) foi nomeado Primeiro Lançamento para Canal Adiado antes de setembro de 2017.
...
-   Correção de um problema em que o proprietário de uma reunião não consegue remover a seleção de usuários na guia de rastreamento.

### <a name="powerpoint-non-security-updates"></a>PowerPoint: Atualizações que não são de segurança
-   Correção de um problema em que o PowerPoint falha quando o usuário tenta abrir ou salvar um arquivo.
...
-   Correção de um problema em que o Word falha ao Salvar como e o usuário selecionou a opção para excluir arquivos do Cache de Documentos do Office quando eles estão fechados.
-   Correção de um problema em que o Word falha ao Salvar como para uma pasta que contém um grande número de arquivos, por exemplo, mais de 30.000 arquivos.
-   Correção de um problema em que o atalho Ctrl+Alt+4 não insere o símbolo do Euro ao usar um teclado do Reino Unido.
...
-   Correção de um problema em que uma atualização trigged pelo Configuration Manager altera a configuração UpdateChannel no Registro para algo que não é um canal de atualização válido.
...
### <a name="excel-security-updates"></a>Excel: Atualizações de segurança
-   Boletim de Segurança da Microsoft [MS16-133](/security-updates/SecurityBulletins/2016/ms16-133): Atualização de segurança do Microsoft Office (3199168)
...
-   Correção de um problema em que o foco muda para uma caixa de diálogo pequena no canto superior direito ao digitar caracteres do Leste Asiático usando um IME (Editor de Método de Entrada), e o usuário não consegue continuar a editar a mensagem de email.

### <a name="skype-for-business-feature-updates"></a>Skype for Business: Atualizações de recursos
-   **Elementos visuais atualizados:** alterações feitas em ícones e cores para aprimorar a acessibilidade. [Mais informações](https://blogs.technet.microsoft.com/nexthop/2016/10/27/new-skype-for-business-2016-look-and-feel-coming-your-way/)
-   **Update UI to “Share”:** Change "Present" to "Share" in UI elements, such as changing "Present Desktop" to "Share your Desktop" and "Present Program" to "Share a Window."

### <a name="skype-for-business-non-security-updates"></a>Skype for Business: Atualizações que não são de segurança
-   Correção de um problema em que o usuário não consegue se conectar ao Exchange para acessar o histórico de conversa, contato ou informações de caixa postal depois que o usuário é migrado para o Exchange Online.
-   Correção de um problema com a janela de conversa em que, ao se tentar colar informações no teclado de discagem ou em anotações de texto no quadro de comunicações, as informações são coladas incorretamente na caixa de texto de entrada de chat.
...
-   Correção de um problema em que metarquivos grandes ou metarquivos altamente ampliados aparecem desfocados.
...
-   Correção de um problema em que o painel de Ajuda aparece como uma caixa de diálogo separada, em vez de dentro do aplicativo, ao selecionar Obter Ajuda ao usar Diga-me.
-   Correção de um problema em que OfficeC2RClient.exe não reconhece "canal" como uma configuração opcional.
-   Correção de um problema em que o novo formato de versão e build não aparece na seção de atualizações do Office em Arquivo \> Conta.
-   Correção de um problema em que mudar para um canal de atualização diferente pode fazer com que um build anterior seja instalado na próxima vez que o processo de atualização for executado.
-   Correção de um problema de impressão em impressoras que usam uma versão V3 do driver de impressora GDI.
...
-   **Melhorias na conectividade e na transformação de dados:** Adicione parâmetros a consultas, crie novas consultas de operações de Mesclar ou Anexar e use o conector Web para visualizar páginas da Web.
-   **Gravação de macro para gráficos:** Suporte para gráficos Treemap, Histograma, Pareto, Cascata, Caixa e Caixa Estreita.
...
-   **Melhorias na conectividade e na transformação de dados:** execução de outras manipulações de Texto e transformações de Data/Hora, migração de pastas de trabalho para ambientes diferentes, agrupamento de duas ou mais cláusulas para filtragem de linhas e transformações de documentos na janela do Editor de Consultas.
-   **Publicar no Power BI:** publique arquivos armazenados localmente no Power BI com uma assinatura deste serviço.
-   **Reconhecimento de formas:** transforme desenhos automaticamente em formas.
-   **Novos conectores:** crie uma consulta usando as opções da nova categoria Online Services, que incluem conectores para o SharePoint Online, para o Exchange e para o SAP HANA.
-   **Tabelas Dinâmicas com conexões OLAP:** melhoramos o desempenho para criação, edição e atualização de Tabelas Dinâmicas com conexões OLAP.
...
### <a name="excel-security-updates"></a>Excel: Atualizações de segurança
-   Boletim de Segurança da Microsoft [MS16-088](/security-updates/SecurityBulletins/2016/ms16-088): Atualização de segurança do Microsoft Office (3170008)
-   Boletim de Segurança da Microsoft [MS16 107](/security-updates/SecurityBulletins/2016/ms16-107): Atualização de segurança do Microsoft Office (3185852)
...
-   Correção de um problema em que, ao se usar o Solver, uma mensagem de erro "Arquivo Solver32.dll não encontrado" é exibida após escolher Resolver.
-   Correção de um problema em que o ícone do Suplemento do Bing Mapas não é mostrado quando é usado um monitor com DPI Alto e o modo de toque está habilitado para a faixa de opções
-   Correção de um problema em que as regras de formatação condicional não funcionam depois de abrir um arquivo foi salvo no formato .xls.
-   Correção de um problema com a versão de 64 bits do Excel, no qual o usuário obtém um erro em vez de um prompt de senha ao tentar se conectar a consultas do Access que fazem referência a tabelas ODBC vinculadas que exigem um prompt de senha para autenticação para o servidor back-end.
-   Correção de um problema em que o Excel trava ao escolher um item em uma lista suspensa.
...
-   Correção de um problema em que a tecla Enter não funciona para separar as entradas da lista ao criar uma lista de classificação personalizada na caixa de diálogo Listas Personalizadas.
...
-   Correção de um problema no qual o Excel não informa as alterações de valor da célula ao Narrador em algumas condições.

### <a name="onenote-security-updates"></a>OneNote: Atualizações de segurança
-   Boletim de Segurança da Microsoft [MS16-099](/security-updates/SecurityBulletins/2016/ms16-099): Atualização de segurança do Microsoft Office (3177451)
...
-   **\@ menções:** certifique-se de que os destinatários saibam que estão sendo solicitados entrada ou ação incluindo o símbolo @ seguido pelo nome da pessoa ao corpo de um email ou item de calendário. Isso irá adicioná-los automaticamente à linha Para. [Mais informações](https://support.office.com/article/90701709-5dc1-41c7-aa48-b01d4a46e8c7)
...
### <a name="outlook-non-security-updates"></a>Outlook: Atualizações que não são de segurança
-   Correção de um problema em que ocorre uma falha no Windows 7 ao tentar criar perfis pelo Painel de Controle usando o Application Virtualization (App-V) com outros aplicativos e a chave de registro AllowJitvInAppvVirtualizedProcess é definida.
-   Correção de um problema em que o proprietário de uma reunião não consegue remover a seleção de usuários na guia de rastreamento.
-   Correção de um problema em que o Outlook falha ao executar uma Localização Avançada em várias pastas.
-   Correção de um problema em que o texto digitado na caixa de texto cc em uma pesquisa não é acrescentado à caixa de pesquisa principal e uma pesquisa não ocorre.
-   Correção de um problema em que, em uma conversa com várias mensagens com anexos, o Outlook falha ao tentar abrir um anexo em uma dessas mensagens, se o anexo estiver armazenado em um local online.
...
-   Correção de um problema em que os usuários não conseguem visualizar anexos de imagem nas mensagens.
...
-   correção de um problema em que, ao criar um formulário personalizado, arrastar campos para o formulário faz com que o Outlook falhe.
-   Correção de um problema em que o painel Pastas desaparece depois de abrir o Outlook.
-   Correção de um problema em que a pesquisa de mensagens com o recurso Localização Avançada em campos de texto usados frequentemente resulta na mensagem de erro "O Outlook não pode executar a pesquisa".
...
-   Correção de um problema em que o programa não é exibido corretamente no modo de exibição de edição quando arrastado para outro monitor cuja resolução de tela é diferente.

### <a name="publisher-non-security-updates"></a>Publisher: Atualizações que não são de segurança
-   Correção de um problema em que as alterações de cor e transparência de uma imagem não são exibidas quando o arquivo é salvo como PDF.
...
-   Boletim de Segurança da Microsoft [MS16-097](/security-updates/SecurityBulletins/2016/ms16-097): Atualização de Segurança do Componente Microsoft Graphics (3177393)
-   Boletim de Segurança da Microsoft [MS16-120](/security-updates/SecurityBulletins/2016/ms16-120): atualização de segurança do componente Microsoft Graphics (3192884)
...
-   Correção de um problema em que a localização dos números de telefone não é mostrada em convites de reunião.
-   Correção de um problema com o ponteiro do mouse em cenários de controle remoto com DPI alto.
-   Correção de um problema em que um participante não consegue ver a área de trabalho compartilhada quando outros participantes alternam para a área de trabalho compartilhada que estiver sendo exibida.
-   Correção de um problema em que a entrada falha com um problema de certificado.
-   Correção de um problema em que o Modo de Exibição de Quadro não carrega na parte superior da tela ao alternar do Modo de Exibição de Galeria para Modo de Exibição de Conteúdo e de volta ao Modo de Exibição de Galeria.
-   Correção de um problema com em que a entrada falha durante a autenticação do Exchange.
-   Correção de um problema em que, quando o compartilhador estiver usando uma implementação de terceiros do RDP e a resolução do compartilhador for inferior à resolução do visualizador, o Skype for Business trava se a exibição maximiza a janela do Skype.
-   Correção de um problema em que o botão Conteúdo não funciona na tela Frente da Sala.
-   Correção de um problema em que reingressar em uma reunião falha em computadores configurados para URLs de arquivo pac de proxy interno no Internet Explorer como um script de configuração automática.
-   Correção de um problema em que, ao usar atalhos de teclado para ativar ou desativar um vídeo, leitores de tela, como o Narrador, não anunciam as alterações.
-   Correção de um problema em que a caixa de diálogo Editar Local não tem rótulos que leitores de tela, como o Narrador, podem usar.
-   Correção de um problema em que os leitores de tela, como o Narrador, não tratam corretamente as notificações de alerta que aparecem logo abaixo da faixa de opções.
...
-   Correção de um problema em que um histórico de chats salvo é exibido no Outlook como uma mensagem de rascunho e não pode ser respondida.
-   Correção de um problema em que o idioma do título da janela principal não é alterado quando o usuário muda o idioma padrão do Office.
-   Correção de um problema em que a guia Relação mostra um contato externo várias vezes, em vez de apenas uma.
-   Correção de um problema no qual o usuário visualiza a mensagem "Somente Mensagens Offline" indevidamente, quando o destinatário não consegue receber mensagens offline.
-   Correção de um problema em que, quando o usuário adiciona um delegado no Exchange Server, ele não é exibido no evento do Skype for Business, depois de reiniciá-lo.
-   Correção de um problema em que guias desaparecem ao entrar quando a opção de reabrir conversas está definida.
-   Correção de um problema em que um leitor de tela não consegue anunciar a chegada de uma nova mensagem em uma conversa de mensagem instantânea.
...
-   **Verificador de Acessibilidade:** Verifique seu diagrama quanto a problemas de acessibilidade indo em Arquivo \> Informações \> Verificar Problemas \> Verificar Acessibilidade.
...
-   **Researcher:** localize citações relevantes, fontes citáveis e imagens sem sair do Word. [Mais informações](https://support.office.com/article/1728f286-8702-4d72-8169-ab7677ca0e1f)
-   **Recursos de colaboração agrupados na faixa de opções:** Recursos como compartilhamento, bate-papo, comentários, atividades do documento e quem está editando o documento foram agrupados na Faixa de Opções. [Mais informações](https://blogs.office.com/2016/04/26/new-to-office-365-in-april-skype-for-business-mac-preview-bringing-collaboration-to-the-forefront-in-office-and-more/)
-   **Toque em:** Encontre e reutilize conteúdo de documentos relevantes da sua organização. [Mais informações](https://support.office.com/article/860118fc-1f61-41f6-922f-40084a284658)
...
-   Boletim de Segurança da Microsoft [MS16-088](/security-updates/SecurityBulletins/2016/ms16-088): Atualização de segurança do Microsoft Office (3170008)
-   Boletim de Segurança da Microsoft [MS16-099](/security-updates/SecurityBulletins/2016/ms16-099): Atualização de segurança do Microsoft Office (3177451)
-   Boletim de Segurança da Microsoft [MS16 121](/security-updates/SecurityBulletins/2016/ms16-121): Atualização de segurança do Microsoft Office (3194063)

### <a name="word-non-security-updates"></a>Word: Atualizações que não são de segurança
-   Correção de um problema em que a fonte é alterada para Segoe UI Emoji ao inserir caracteres de símbolos do DBCS (conjunto de caracteres de byte duplo) ao usar o IME (editor de método de entrada) japonês.
-   Correção de um problema em que o usuário é solicitado incorretamente a fornecer credenciais do Blogger quando tenta publicar uma postagem de blog no SharePoint.
-   Correção de um problema em que, quando o usuário altera o padrão de edição ou o idioma de revisão de texto, aquela alteração não é transferida para na próxima vez que o Word for aberto.
...
-   Corrigido um problema com a compactação delta binária que fazia com que o tamanho dos downloads das atualizações para o build anterior fossem maiores do que deveriam.
-   correção de um problema em que a tarefa de Atualização do Office é executada com muita frequência, causando o aumento do uso da CPU e fazendo os ícones da área de trabalho piscarem ou atualizarem brevemente.
...
### <a name="excel-non-security-updates"></a>Excel: Atualizações que não são de segurança
-   Correção de um problema em que a ação de drill-through do OLAP faz com que o Excel pare de funcionar.
...
### <a name="excel-non-security-updates"></a>Excel: Atualizações que não são de segurança
-   Correção de um problema que faz com que a atualização de uma fonte de dados OLAP atinja o tempo limite após um minuto.
-   Correção de um problema que faz com que a última alteração na pasta de trabalho seja desfeita ao salvar uma pasta de trabalho que inclui um nível de desfazer programático usando Application.OnUndo.

### <a name="visio-non-security-updates"></a>Visio: Atualizações que não são de segurança
-   Correção de um problema que faz com que os caracteres digitados apareçam em inglês, embora o teclado esteja configurado para um idioma do Leste Asiático, como coreano.
...
### <a name="office-suite-non-security-updates"></a>Pacote do Office: Atualizações que não são de segurança
-   Correção de um problema com as informações de log do Painel de Telemetria que faz com que as informações sejam substituídas no log antes de serem carregadas para o Painel de Telemetria, além de causar um aumento no tamanho do arquivo a ser carregado.
...
### <a name="excel-feature-updates"></a>Excel: Atualizações de recursos
-   **Obter & melhorias de transformação:** Recursos novos ou aprimorados de conectividade de dados e transformação de dados para o Power Query. [Mais informações](https://blogs.office.com/2016/04/26/more-april-2016-updates-for-get-transform-in-excel-2016-and-the-power-query-add-in/)
...
### <a name="excel-security-updates"></a>Excel: Atualizações de segurança
-   Boletim de Segurança da Microsoft [MS16-042](/security-updates/SecurityBulletins/2016/ms16-042): Atualização de segurança do Microsoft Office (3148775)
...
-   Correção de um problema em que chamar um método ou propriedade em uma planilha excluída faz com que o Excel falhe em vez de mostrar um erro informando que não foi possível encontrar o objeto nessa planilha.
...
### <a name="onenote-non-security-updates"></a>OneNote: Atualizações que não são de segurança
-   Correção de um problema com o recurso de escrita à tinta em que traços aleatórios são selecionados e não podem ser desmarcados.
...
-   **Criação de perfil simplificado:** Uma experiência simplificada de interface de usuário (UI) para configurar perfis adicionais do Outlook para caixas de correio do Office 365 quando você está conectado com uma conta do Office 365.
    ...
    Observação: esse recurso está sendo lançado por um período de tempo para assinantes, portanto, você pode não ver esse recurso imediatamente. O tempo de quando você recebe esse recurso também depende de como sua organização atualiza o Office.
...
-   Correção de um problema em que o link para exibir mensagens de email mais antigas no servidor não aparece na parte inferior da lista de mensagens na pasta, como a pasta Caixa de Entrada ou Itens Excluídos.
-   Correção de um problema em que o Outlook não envia o conteúdo da mensagem ao enviar um email usando um arquivo .msg.
...
### <a name="skype-for-business-security-updates"></a>Skype for Business: Atualizações de segurança
-   Boletim de Segurança da Microsoft [MS16-039](/security-updates/SecurityBulletins/2016/ms16-039): atualização de segurança do componente Microsoft Graphics (3148522)

### <a name="skype-for-business-non-security-updates"></a>Skype for Business: Atualizações que não são de segurança
-   Correção de um problema em que o Skype falha para alguns usuários em reuniões grandes, como reuniões com mais de 30 participantes.
-   Correção de um problema em computadores com software Malwarebytes instalado em que o Skype trava quando o usuário tenta iniciar cenários de áudio ou visuais, como o ingresso ou o compartilhamento da área de trabalho na parte de áudio de uma reunião. [Mais informações sobre este problema](https://support.microsoft.com/kb/3165866)
-   Correção de um problema no qual o usuário recebia uma mensagem de erro quando tentava usar recursos de conferência, como um quadro de comunicações ou o compartilhamento de anotações. [Mais informações sobre este problema](https://support.microsoft.com/kb/3165438)
-   Correção de um problema no qual a tentativa de abrir o cartão de visita de um usuário do Skype gera uma falha no Skype for Business.

### <a name="visio-feature-updates"></a>Visio: Atualizações de recursos
-   **Suporte a AutoCAD:** Importação de arquivos do AutoCAD 2010 e AutoCAD 2013 e sobreposição de formas, texto e gráficos de dados. [Mais informações](https://support.office.com/article/f3e09e21-f064-46cb-acd0-cf97cc3677cc)
-   **Dimensionamento aprimorado do AutoCAD:** Aprimoramentos no dimensionamento ao importar arquivos do AutoCAD.[Mais informações](https://support.office.com/article/92c153ca-0122-4857-bd18-3d9033ff3dc5)
-   **Aprimoramentos do desempenho do AutoCAD:** Importação mais rápida de arquivos do AutoCAD e ao trabalhar com formas na parte superior de um desenho em AutoCAD.

### <a name="visio-security-updates"></a>Visio: Atualizações de segurança
-   Boletim de Segurança da Microsoft [MS16-070](/security-updates/SecurityBulletins/2016/ms16-070): Atualização de segurança do Microsoft Office (3163610)

### <a name="visio-non-security-updates"></a>Visio: Atualizações que não são de segurança
-   Correção de um problema no qual as formas colocadas em um desenho CAD não eram exportadas no tamanho correto.

### <a name="word-feature-updates"></a>Word: Atualizações de recursos
-   **Balões de comentários:** Os botões aparecem no balão Comentário para permitir que você possa facilmente responder, resolver ou reabrir um comentário.

### <a name="word-security-updates"></a>Word: Atualizações de segurança
-   Boletim de Segurança da Microsoft [MS16-054](/security-updates/SecurityBulletins/2016/ms16-054): Atualização de segurança do Microsoft Office (3155544)
-   Boletim de Segurança da Microsoft [MS16-070](/security-updates/SecurityBulletins/2016/ms16-070): Atualização de segurança do Microsoft Office (3163610)
...
-   Correção de um problema com listas de numeração de contexto em persa, árabe, hindi e hebraico.
...
-   Correção de um problema no Word, no Excel e no PowerPoint em que a definição da espessura da caneta para escrita à tinta faz com que o aplicativo falhe.
-   Correção de um problema em que o painel de tarefas Recuperação de Documentos não aparece na próxima vez em que você abrir o aplicativo do Office após ele ter falhado, especialmente se você abrir o aplicativo novamente logo após ele falhar.
-   Atualização do OfficeC2RClient.exe para usar "channel" em vez de "branch" como uma opção de linha de comando.
...
-   Correção de um problema em que usar o Pincel de Formatação para aplicar uma formatação a uma tarefa faz a tela rolar para outro local ou causa falha no Project.
-   Correção de um problema em que, se você arrastar uma tarefa para outra em um gráfico de Gantt, não poderá criar um vínculo entre as duas tarefas.
-   Correção de um problema em que ao mover uma tarefa arrastando-a, ela não é movida para o local correto.
-   Correção de um problema em que ao mover uma coluna arrastando-a em um gráfico de Gantt, ela não é movida para o local correto.
-   Correção de um problema em que salvar um subprojeto do projeto mestre causa falha no Project.
-   Correção de um problema em que abrir um projeto que contém vínculos entre projetos causa falha no Project.
-   Correção de um problema em que os calendários de linha de base são excluídos quando o projeto é salvo e fechado, o que causa falha no Project quando o projeto é reaberto.

### <a name="skype-for-business-non-security-updates"></a>Skype for Business: Atualizações que não são de segurança
-   Correção de um problema em que, ao usar a tecla para cima para rolar pelas mensagens de IM anteriores no histórico do chat, o item selecionado se move inesperadamente de volta para o item na parte inferior do histórico de chat.
-   Correção de um problema em que o Skype incorretamente cria um grupo de contatos em vez de um contato.

### <a name="word-security-updates"></a>Word: Atualizações de segurança
-   Boletim de Segurança da Microsoft [MS16-054](/security-updates/SecurityBulletins/2016/ms16-054): Atualização de segurança do Microsoft Office (3155544)

### <a name="word-non-security-updates"></a>Word: Atualizações que não são de segurança
-   Correção de um problema em que tentar carregar um arquivo de fonte inválido causa falha no Word.
...
### <a name="powerpoint-non-security-updates"></a>PowerPoint: Atualizações que não são de segurança
-   Correção de um problema em que imprimir um documento causa falha no PowerPoint.
...
-   Correção de um problema em que um problema com uma DLL de recurso causa falha no aplicativo do Office quando é aberto pela primeira vez após a instalação, ao imprimir um documento ou ao desfazer uma operação de edição.



## <a name="version-1602-april-12"></a>Versão 1602: 12 de abril
*Versão 1602 (build 6741.2026)*
...
-   Boletim de Segurança da Microsoft [MS15-116](/security-updates/SecurityBulletins/2015/ms15-116): Atualização de Segurança do Microsoft Office para Tratar da Execução de Código Remoto (3104540)
...
-   **Gráficos de funil**: exibem valores como proporções progressivamente decrescentes. [Mais informações](https://support.office.com/article/ba21bcba-f325-4d9f-93df-97074589a70e)
-   **Melhoria no preenchimento automático de fórmulas**: o Excel agora retorna todas as correspondências parciais quando o usuário digita um nome de função, não apenas as correspondências exatas do início da cadeia de caracteres.
-   **Novas funções de texto**: duas novas funções de texto agora estão disponíveis: [CONCAT](https://support.office.com/article/9b1a9a3f-94ff-41af-9736-694cbd6b4ca2) e [UNIRTEXTO](https://support.office.com/article/357b449a-ec91-49d0-80c3-0e8fc845691c)
-   **Novas funções lógicas**: duas novas funções lógicas agora estão disponíveis: [SES](https://support.office.com/article/36329a26-37b2-467c-972b-4a39bd951d45) e [PARÂMETRO](https://support.office.com/article/47ab33c0-28ce-4530-8a45-d532ec4aa25e)
-   **Novas funções estatísticas**: duas novas funções estatísticas agora estão disponíveis: [MÁXIMOSES](https://support.office.com/article/dfd611e6-da2c-488a-919b-9b6376b28883) e [MÍNIMOSES](https://support.office.com/article/6ca1ddaa-079b-4e74-80cc-72eef32e6599)
...
### <a name="excel-security-updates"></a>Excel: Atualizações de segurança
-   Boletim de Segurança da Microsoft [MS15-099](/security-updates/SecurityBulletins/2015/ms15-099): vulnerabilidades do Microsoft Office poderão permitir a execução remota de código (3089664)
-   Boletim de Segurança da Microsoft [MS15-110](/security-updates/SecurityBulletins/2015/ms15-110): atualizações de segurança do Microsoft Office para tratar da execução de código remoto (3096440)
-   Boletim de Segurança da Microsoft [MS15-116](/security-updates/SecurityBulletins/2015/ms15-116): Atualização de Segurança do Microsoft Office para Tratar da Execução de Código Remoto (3104540)
-   Boletim de Segurança da Microsoft [MS16-004](/security-updates/SecurityBulletins/2016/ms16-004): Atualização de Segurança do Microsoft Office para Tratar da Execução de Código Remoto (3124585)
-   Boletim de Segurança da Microsoft [MS16-015](/security-updates/SecurityBulletins/2016/ms16-015): Atualização de Segurança do Microsoft Office para Tratar da Execução de Código Remoto (3134226)
...
-   Correção de um problema em que a faixa de opções Inquire não é exibida depois que o suplemento Inquire é habilitado.
-   Correção de um problema em que usar Application.OnKey() para interceptar um pressionamento de tecla causa falha no Excel.
...
-   Correção de um problema em que não abre a versão de idioma espanhol do OneDrive for Business e, em vez disso, uma mensagem de erro sobre falha ao carregar uma imagem é exibida.
...
### <a name="onenote-non-security-updates"></a>OneNote: Atualizações que não são de segurança
-   Correção de um problema no qual o realce de conteúdo não aparecia ao usar a opção Ver Reprodução.
...
### <a name="outlook-feature-updates"></a>Outlook: Atualizações de recursos
-   **Comando Arquivar na faixa de opções:** Permite que você mova rapidamente um item armazenado em sua Caixa de Entrada ou em qualquer outra pasta para uma pasta de arquivamento. [Mais informações](https://support.office.com/article/25f75777-3cdc-4c77-9783-5929c7b47028)
-   **Trabalhar com grupos:** Navegue, registre e crie grupos no Outlook e adicione outros aos Favoritos para seguir de forma mais ativa. [Mais informações](https://support.office.com/article/04d0c9cf-6864-423c-a380-4fa858f27102)
-   **Imagem de contato sugerido:** Ao pesquisar no Outlook usando um nome, agora a imagem de uma pessoa aparece ao lado de seu nome na lista de contatos sugeridos.
-   **Ferramenta de resolução de problemas:** Diagnosticar e resolver alguns dos problemas encontrados com mais frequência do Outlook ao executar a ferramenta de Assistente de Recuperação e Suporte em Arquivo \> Solução de Problemas.
...
### <a name="outlook-non-security-updates"></a>Outlook: Atualizações que não são de segurança
-   Correção de um problema no qual a criação de um perfil causava uma falha no Outlook. [Mais informações sobre este problema](https://support.microsoft.com/kb/3098011)
-   Correção de um problema no qual a navegação por uma mensagem causava uma falha no Outlook.
-   Correção de um problema no qual o cursor sofria atraso enquanto o usuário digitava.
-   Correção de um problema no qual, se o remetente da mensagem anexasse um arquivo ao responder a um email em HTML que continha imagens incorporadas no corpo ou na assinatura, o destinatário da mensagem recebia a mensagem, mas não o anexo.
-   Correção de um problema no uso de Colar Tudo para copiar endereços da área de transferência do Calendário para uma nova reunião.
...
-   Correção de um problema em que, quando configurada para usar POP3, as mensagens de email são baixadas várias vezes, causando itens duplicados. [Mais informações sobre este problema](https://support.microsoft.com/kb/3145116)
...
### <a name="powerpoint-feature-updates"></a>PowerPoint: Atualizações de recursos
-   **Presença em tempo real:** Veja quem está trabalhando na apresentação e em qual slide cada pessoa está trabalhando. [Mais informações](https://support.office.com/article/0c30ee3f-8674-4f0e-97be-89cf2892a34d)
...
-   **Designer do PowerPoint:** um novo serviço que permite que você pegue o seu conteúdo e crie automaticamente várias ideias que podem ser escolhidas para melhorar a aparência de seus slides. [Mais informações](https://support.office.com/article/53c77d7b-dc40-45c2-b684-81415eac0617)
    ...
    Este serviço requer conectividade com a Internet. Para desabilitar esse recurso, [use os](https://www.microsoft.com/download/details.aspx?id=49030) arquivos de Modelo Administrativo de Política de Grupo mais recentes e habilita a configuração Opções do Designer do PowerPoint. Você pode encontrar esta configuração de política em Configurações do Usuário\\Modelos Administrativos\\Microsoft Office 2016\\Ferramentas | Opções | Geral | Opções de Serviço…\\Designer do PowerPoint.

### <a name="powerpoint-security-updates"></a>PowerPoint: Atualizações de segurança
-   Boletim de Segurança da Microsoft [MS15-116](/security-updates/SecurityBulletins/2015/ms15-116): Atualização de Segurança do Microsoft Office para Tratar da Execução de Código Remoto (3104540)
-   Boletim de Segurança da Microsoft [MS15-004](/security-updates/SecurityBulletins/2016/ms16-004): Atualização de Segurança do Microsoft Office para Tratar da Execução de Código Remoto (3124585)

### <a name="powerpoint-non-security-updates"></a>PowerPoint: Atualizações que não são de segurança
-   Correção de um problema em que usar \# para inserir um número de slide em um slide mestre dentro de uma caixa de texto não exibe o número do slide.
...
-   Correção de um problema em que escolher editar dados para um gráfico em um slide duplicado, enquanto a grade de dados do gráfico para o slide original estiver aberta, faz com que o PowerPoint falhe.
-   Correção de um problema em que aparece o ícone de áudio, mesmo que ele tenha sido configurado para ser ocultado durante uma apresentação de slides, quando exibindo uma apresentação que foi exportada em um formato de vídeo.
-   Correção de um problema em que a caixa de diálogo Ideas de Design continua a ser exibida ao inserir imagens depois que o usuário seleciona "Não, obrigado".
...
### <a name="skype-for-business-security-updates"></a>Skype for Business: Atualizações de segurança
-   Boletim de Segurança da Microsoft [MS15-116](/security-updates/SecurityBulletins/2015/ms15-116): Atualização de Segurança do Microsoft Office para Tratar da Execução de Código Remoto (3104540)
-   Boletim de Segurança da Microsoft [MS15-123](/security-updates/SecurityBulletins/2015/ms15-123): atualização de segurança do Skype for Business e Microsoft Lync para tratar da divulgação de informações (3105872)
-   Boletim de Segurança da Microsoft [MS15-128](/security-updates/SecurityBulletins/2015/ms15-128): atualização de segurança do componente do Microsoft Graphics para tratar da execução de código remoto (3104503)
...
### <a name="visio-security-updates"></a>Visio: Atualizações de segurança
-   Boletim de Segurança da Microsoft [MS15-081](/security-updates/SecurityBulletins/2015/ms15-081): vulnerabilidades do Microsoft Office poderão permitir a execução remota de código (3080790)
-   Boletim de Segurança da Microsoft [MS15-116](/security-updates/SecurityBulletins/2015/ms15-116): Atualização de Segurança do Microsoft Office para Tratar da Execução de Código Remoto (3104540)
-   Boletim de Segurança da Microsoft [MS16-004](/security-updates/SecurityBulletins/2016/ms16-004): Atualização de Segurança do Microsoft Office para Tratar da Execução de Código Remoto (3124585)
...
-   Boletim de Segurança da Microsoft [MS15-081](/security-updates/SecurityBulletins/2015/ms15-081): vulnerabilidades do Microsoft Office poderão permitir a execução remota de código (3080790)
-   Boletim de Segurança da Microsoft [MS15-116](/security-updates/SecurityBulletins/2015/ms15-116): Atualização de Segurança do Microsoft Office para Tratar da Execução de Código Remoto (3104540)
-   Boletim de Segurança da Microsoft [MS15-131](/security-updates/SecurityBulletins/2015/ms15-131): Atualização de Segurança do Microsoft Office para Tratar da Execução de Código Remoto (3116111)
-   Boletim de Segurança da Microsoft [MS16-004](/security-updates/SecurityBulletins/2016/ms16-004): Atualização de Segurança do Microsoft Office para Tratar da Execução de Código Remoto (3124585)
-   Boletim de Segurança da Microsoft [MS16-015](/security-updates/SecurityBulletins/2016/ms16-015): Atualização de Segurança do Microsoft Office para Tratar da Execução de Código Remoto (3134226)
-   Boletim de Segurança da Microsoft [MS16-029](/security-updates/SecurityBulletins/2016/ms16-029): Atualização de Segurança do Microsoft Office para Tratar da Execução de Código Remoto (3141806)
...
-   Correção de um problema em que o Word não exibe a formatação correta ao editar um documento. [Mais informações sobre este problema](https://answers.microsoft.com/en-us/office/forum/office_2016-word/word-2016-doesnt-display-your-document-formatting/b7bb4017-8ae5-41ab-881b-03199d24ba83)
...
-   **Tema preto:** Um novo tema para fornecer o nível mais alto de contraste nos aplicativos Word, Excel, PowerPoint, Outlook e OneNote. [Mais informações](https://support.office.com/article/63e65e1c-08d4-4dea-820e-335f54672310)
-   **Anotações à tinta:** Use o dedo ou uma caneta nos aplicativos Word, Excel ou PowerPoint para escrever e desenhar e use as ferramentas da nova guia Desenhar para realçar conteúdo de interesse específico. [Mais informações](https://support.office.com/article/c00b7319-2b50-4784-8114-47593d991c5c)
...
-   **Inserir API de imagem:**  Insira imagens no Word, Excel ou PowerPoint usando o [método document.setSelectedDataAsync](/javascript/api/office/office.document) na biblioteca office.js comum. A API do JavaScript do Word fornece métodos específicos de host chamados insertInlinePictureFromBase64() para definir as imagens embutidas nos objetos [Body](/office/dev/add-ins/reference/overview/word-add-ins-reference-overview), [ContentControl](/javascript/api/word/word.contentcontrol),[Parágrafo](/javascript/api/word/word.paragraph)e Range objects.
...
-   Correção de um problema em que um ícone especificado na Interface do Usuário personalizada com atributo imageMSO não é exibido nos aplicativos Word, Excel ou PowerPoint.
-   Correção de um problema em que abrir um aplicativo após instalar o Office do office.com faz com que o aplicativo falhe se o computador não tiver acesso à Internet ou não puder acessar o Serviço de Licenciamento do Office na Internet.
...
### <a name="excel-security-updates"></a>Excel: Atualizações de segurança
-   Boletim de Segurança da Microsoft MS [16-015](/security-updates/SecurityBulletins/2016/ms16-015): Atualização de Segurança do Microsoft Office para Tratar da Execução de Código Remoto (3134226)
