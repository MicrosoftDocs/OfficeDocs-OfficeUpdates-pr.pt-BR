...
O Office para Mac que vem com uma assinatura do Microsoft 365 é atualizado regularmente para fornecer novos recursos, atualizações de segurança e atualizações que não são de segurança.
...
> [!NOTE]
> - Se você for um Office Insider, confira as [Notas de lançamento do Canal beta do Mac](https://insider.office.com/releasenotes/mac/fast).
...
> - Frequentemente, implementamos recursos (e às vezes até corrigimos) ao longo de um período de tempo. Isso nos permite garantir que tudo esteja funcionando perfeitamente antes de lançar o recurso para um público mais amplo. Portanto, se você não vir algo descrito abaixo, não se preocupe, você vai conseguir eventualmente. [Saber mais](https://support.office.com/en-us/article/when-do-i-get-the-newest-features-in-for-office-365-da36192c-58b9-4bc9-8d51-bb6eed468516?ui=en-US&rs=en-US&ad=US)
> - Às vezes, lançamos atualizações contendo melhorias gerais de qualidade e desempenho e nenhum recurso novo. Se um aplicativo não estiver especificamente listado abaixo, a atualização para esse aplicativo incluirá apenas melhorias de qualidade e desempenho.
...
- **Abra Caixas de Correio Compartilhadas e configure a Delegação:** Agora você pode configurar cenários de delegação e abrir caixas de correio compartilhadas no Novo Outlook para Mac

- **Sugestões de escrita do Editor com um único clique:** obtenha sugestões de ortografia, gramática e outras sugestões de escrita inteligente com um único clique com o botão direito (Alt+Down). Use o botão esquerdo para ver o novo design do cartão e descobrir outras opções como Adicionar ao dicionário, Mostrar contexto, Sinônimos e muito mais. [Saiba mais](https://support.office.com/article/c6b1283d-81a2-47f1-bc85-9e8dfc0cbf15)

- **Dite suas mensagens com comandos de voz:** a nova barra de ferramentas de ditado, comandos de voz e pontuação automática tornam a criação de conteúdo com sua voz rápida e fácil.<br />Consulte os detalhes na [postagem do blog](https://insider.office.com/pt-BR/blog)

- **Compartilhar com o Microsoft Teams:** envie uma cópia das mensagens de email ou inicie um chat do Teams relacionado a uma mensagem de email específica. Ao compartilhar com o Teams do Outlook para Mac, uma janela pop-up aparecerá para confirmar o canal ou pessoa com quem você deseja compartilhar, você também pode selecionar se deseja ou não incluir anexos.
...
- **Responder no chat:** capacidade de responder a uma mensagem específica no chat.

- **Personalizar aplicativos no Microsoft Teams:** o recurso de personalização de aplicativos permite que os desenvolvedores especifiquem certas propriedades dos aplicativos do Teams para serem personalizáveis, além de permitir que os administradores de TI marquem novamente qualquer uma dessas propriedades no Centro de administração do Teams. Como exemplo, os administradores de TI podem personalizar o nome, a descrição e os ícones do aplicativo Now Virtual Agent do ServiceNow para atender às necessidades exclusivas de sua organização.
...
-   [CVE-2021-31177](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2021-31177)

[//]: # (NÃO REMOVER O FINAL DO CONTEÚDO DE DETALHES DE SEGURANÇA)

## <a name="april-13-2021"></a>13 de abril de 2021
*Versão 16.48 (Build 21041102)*
...
- **Ensaie suas apresentações com o Orientador de Apresentações:** o Orientador de Apresentações ajuda você a ensaiar suas apresentações para envolver o público de maneira mais eficaz. Ele fornece feedback sobre seu ritmo, tom, uso de palavras de preenchimento e muito mais. [Saiba mais](https://support.office.com/article/cd7fc941-5c3b-498c-a225-83ef3f64f07b)<br />Consulte os detalhes na [postagem do blog](https://insider.office.com/pt-BR/blog/presenter-coach-now-in-powerpoint-on-mac)
...
- **O Editor oferece sugestões de redação com um único clique:** obtenha sugestões de ortografia, gramática e outras sugestões de redação inteligente com um único clique com o botão direito (Alt+Down). Use o botão esquerdo para ver o novo design do cartão e descobrir outras opções como Adicionar ao dicionário, Mostrar contexto, sinônimos e mais.
...
-   [CVE-2021-28451](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2021-28451)
-   [CVE-2021-28456](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2021-28456)

### <a name="word"></a>Word

-   [CVE-2021-28453](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2021-28453)
...
- **Pesquisar é mais rápido e simples:** rapidamente pesquisar o arquivo usando a caixa de pesquisa
...
- **Atualizar os dados do Microsoft SQL Server:** atualize as consultas do Power Query no Mac do Microsoft SQL Server

- **Criar Variáveis para Usar em Fórmulas:** melhore o desempenho, a legibilidade e a capacidade de composição com a função LET. Esta função permite que você crie variáveis nomeadas em fórmulas novas ou pré-existentes. [Saiba mais](https://support.office.com/article/34842dd8-b92b-4d3f-b325-b8b8f9908999)<br />Consulte os detalhes na [postagem do blog](https://insider.office.com/pt-BR/blog/let-names-in-formulas-for-excel)

- **Faça Diagramas do Visio Elegantes no Excel:** criar diagramas orientados para dados como fluxogramas ou organogramas de dados em uma planilha. [Saiba mais](https://support.office.com/article/bee3b5aa-aaaf-4401-acc6-276b711c763c)

- **Aperfeiçoe Suas Pastas de Trabalho:** dê mais estilo à sua planilha com imagens, ícones e imagens de arquivo gratuitos e de alta qualidade. Vá para Inserir > Imagens > Imagens de estoque para começar. [Saiba mais](https://support.office.com/article/c7b78cdf-2503-4993-8664-851085c30fce)
...
- **Aperfeiçoe Seus Slides:** Dê mais estilo às suas apresentações com imagens, ícones e imagens de arquivo gratuitas e de alta qualidade. Vá para Inserir > Imagens > Imagens de estoque para começar. [Saiba mais](https://support.office.com/article/c7b78cdf-2503-4993-8664-851085c30fce)

### <a name="powerpoint-mac"></a>PowerPoint para Mac

- **Melhor experiência de gravação áudio :** experiência mais simples para adicionar seu próprio áudio gravado
...
-   [CVE-2020-16929](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2020-16929)

### <a name="word"></a>Word

-   [CVE-2020-16933](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2020-16933)

### <a name="office-suite"></a>Pacote Office

-   [CVE-2020-16918](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2020-16918)
...
- **Filtrar e Classificar Sem Interromper os Outros:** Criar sua própria exibição ao colaborar com outras pessoas no Excel, para que você possa filtrar e classificar sem interromper o que outras pessoas veem. [Saiba mais](https://support.office.com/article/0eea3dc5-d7d1-44c5-a953-25ebfbd6c1a6)<br />Consulte os detalhes na [postagem do blog](https://insider.office.com/pt-BR/blog/sheet-view-makes-collaborating-easier)

### <a name="outlook"></a>Outlook

- **Melhora na segurança para contas do Outlook.com:** Melhorias de segurança significa que você não precisa mais de definir uma senha de aplicativo quando a verificação em duas etapas estiver habilitada para sua conta do Outlook.com.
...
-   [CVE-2020-1495](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2020-1495)
-   [CVE-2020-1498](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2020-1498)

### <a name="word"></a>Word

-   [CVE-2020-1503](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2020-1503)
-   [CVE-2020-1583](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2020-1583)

[//]: # (NÃO REMOVER O FINAL DO CONTEÚDO DE DETALHES DE SEGURANÇA)

## <a name="july-14-2020"></a>14 de julho de 2020
*Versão 16.39 (Build 20071300)*
...
- **Adicione rótulos de gráfico de valores de célula:** use valores de células como rótulos em seus dados de gráfico. [Saiba mais](https://support.office.com/article/884bf2f1-2e29-454e-8b42-f467c9f4eb2d)
...
- **Ação rápida na ponta dos dedos:** Mensagens acionáveis permitem executar ações rápidas como a aprovação e o preenchimento de uma pesquisa diretamente no seu email.
...
-   [CVE-2020-1409](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2020-1409)

[//]: # (NÃO REMOVER O FINAL DO CONTEÚDO DE DETALHES DE SEGURANÇA)

## <a name="june-16-2020"></a>16 de junho de 2020
*Versão 16.38 (Build 20061401)*
...
- **Extrair dados de uma foto:** Adicionar dados de tabela de imagens, da guia Inserir ou diretamente do seu iPhone. [Saiba mais](https://support.office.com/article/3c1bb58d-2c59-4bc0-b04a-a671a6868fd7)<br />Consulte os detalhes na [postagem do blog](https://blog-insider.office.com/2020/04/13/data-from-picture-in-excel/)

### <a name="outlook"></a>Outlook

- **Outlook sem usar as mãos:** Tem um microfone? Clique em Ditar e veja o Outlook digitar enquanto você fala.  [Saiba mais](https://support.office.com/article/4010d238-bb25-45e9-89f6-8f9b54fcc0fc)

### <a name="powerpoint"></a>PowerPoint

- **Sincronizar alterações durante a apresentação:** Sincronizar alterações sempre que elas forem feitas, mesmo quando a apresentação estiver no modo de apresentação de slides.<br />Consulte os detalhes na [postagem do blog](https://blog-insider.office.com/2020/04/08/synchronize-changes-while-presenting/)
...
- **Diga a verdade:** Você tem uma pergunta sobre seu dados? Nas Ideias do Excel, insira uma pergunta e te daremos a resposta. [Saiba mais](https://support.office.com/article/3223aab8-f543-4fda-85ed-76bb0295ffc4)
...
-   [CVE-2020-0901](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2020-0901)
...
- **Rótulos de confidencialidade**: agora você pode aplicar um rótulo de confidencialidade que sua organização configurou para solicitar permissões personalizadas. [Saiba Mais](/microsoft-365/compliance/encryption-sensitivity-labels?view=o365-worldwide#let-users-assign-permissions)
...
- **Atualizar dados de tabelas locais e intervalos:** Atualize suas consultas do Power Query no Mac a partir de intervalos e tabelas locais.
...
- **Digite uma Fórmula que Retorna Vários Valores:** digite rapidamente uma fórmula que retorna vários valores e eles serão automaticamente enviados para as células vizinhas. [Saiba mais](https://support.office.com/article/5c2c9cbb-def8-409a-b380-2fbf91b20aa3)

- **Criar e gerenciar consultas com o VBA no Mac:** Criar e gerenciar as consultas do Power Query para fontes suportadas no Mac com VBA.

### <a name="powerpoint"></a>PowerPoint

- **GIFs em instantes:** Um slide, um quadro. Crie facilmente GIFs de loop no PowerPoint. [Saiba mais](https://support.office.com/article/a598753e-92de-4f1b-8393-714db4d334b4)

### <a name="word"></a>Word

- **Acessibilidade incorporada: Suporte para o High Sierra:** adicionamos suporte para a High Sierra, incluindo idioma, links e tabelas no rotor, e suporte aprimorado para localização.
...
- **Expresse Suas Ideias:** converta sua escrita à tinta em formas, texto ou matemática com aparência profissional. [Saiba mais](https://support.office.com/article/0740dec3-6291-4c1f-8baa-011d18449919)
...
-   [CVE-2019-1464](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1464)

### <a name="powerpoint"></a>PowerPoint

-   [CVE-2019-1462](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1462)

[//]: # (NÃO REMOVER O FINAL DO CONTEÚDO DE DETALHES DE SEGURANÇA)

## <a name="november-12-2019-release"></a>Versão de 12 de novembro de 2019
*Versão 16.31 (Build 19111002)*
...
- **Suplemento do Excel Visualizador de Dados do Visio:** Visualize seus dados de forma rápida e fácil nos diagramas elegantes do Visio no Excel.



 ### <a name="excel-security-updates"></a>Excel: Atualizações de segurança

- [CVE-2019-1446](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1446): Vulnerabilidade de Divulgação de Informações do Microsoft Excel
- [CVE-2019-1448](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1448): Vulnerabilidade de Execução Remota de Código no Microsoft Excel
- [CVE-2019-1457](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1457): Bypass de Recursos de Segurança do Microsoft Office Excel
...
- Correção de vários problemas de desempenho.<br/><br/>

## <a name="october-15-2019-release"></a>15 de outubro de 2019
*Versão 16.30 (Build 19101301)*

### <a name="word-feature-updates"></a>Word: Atualizações de recursos

- **Edite seu PDF no Word:** abra o PDF, converta-o em um documento do Word e comece a editar.
### <a name="excel--feature-updates"></a>Excel: Atualizações de recursos
...
- [CVE-2019-1327](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1327): Vulnerabilidade de execução de código remoto no Microsoft Excel
- [CVE-2019-1331](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1331): Vulnerabilidade de execução de código remoto no Microsoft Excel

### <a name="powerpoint-feature-updates"></a>PowerPoint: Atualizações de recursos

- **Repetição instantânea:** anime um desenho a tinta para que ele seja reproduzido para frente ou para trás durante a apresentação de slides. [Saiba mais](https://support.office.com/article/fa4f044f-810b-43fe-b774-da04a0b37496
)
...
- **Guias de planilha coloridas:** quando você escolha uma cor de guia para a planilha, ela preenche toda a guia para que seja mais fácil de vê-la.

- **Atualizar dados de arquivos locais no Mac:** atualize as consultados do Power Query no Mac, a partir de arquivos de texto, CSV, XLSX, XLM e JSON. 

 ### <a name="excel-security-updates"></a>Excel: Atualizações de segurança

- [CVE-2019-1263](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1263): vulnerabilidade de Divulgação de Informações do Microsoft Excel
- [CVE-2019-1297](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1297): vulnerabilidade de Execução do Código Remoto do Microsoft Excel
...
- [CVE-2019-1201](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1201): Vulnerabilidade de Execução Remota de Código do Microsoft Word
- [CVE-2019-1205](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1205): Vulnerabilidade de Execução Remota de Código do Microsoft Word
...
- [CVE-2019-1148](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1148): Vulnerabilidade de Divulgação de Informações do Componente do Microsoft Graphics
- [CVE-2019-1149](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1149): Vulnerabilidade de Execução Remota de Código do Microsoft Graphics
- [CVE-2019-1151](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1151): Vulnerabilidade de Execução Remota de Código do Microsoft Graphics
- [CVE-2019-1153](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1153): Vulnerabilidade de Divulgação de Informações do Componente do Microsoft Graphics
...
- [CVE-2019-1110](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1110): Vulnerabilidade de Execução do Código Remoto do Microsoft Excel
- [CVE-2019-1111](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1111): Vulnerabilidade de Execução do Código Remoto do Microsoft Excel
### <a name="powerpoint-feature-updates"></a>PowerPoint: Atualizações de recursos
...
- **Suporte ao Modo Escuro no Painel de Leitura:** os emails que você receber agora têm um plano de fundo escuro para facilitar a visualização em ambientes com pouca iluminação. Exige o Mojave macOS.  
### <a name="outlook-security-updates"></a>Outlook: Atualizações de segurança

- [CVE-2019-1084](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1084): Vulnerabilidade de divulgação de informações do Microsoft Exchange<br/><br/>
...
- [CVE-2019-1034](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1034): Vulnerabilidade de Execução Remota de Código do Microsoft Word
- [CVE-2019-1035](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-1035): Vulnerabilidade de Execução Remota de Código do Microsoft Word

### <a name="excel-feature-updates"></a>Excel: Atualizações de recursos

- **Chame a atenção das pessoas com \@Menções:** Use @menções nos comentários para que outras pessoas saibam quando você precisar da contribuição delas.
- **Agrupar ou Não Agrupar:** as datas da tabela dinâmica não devem ser agrupadas. Desativar o agrupamento automático no: Excel > Preferências > Tabelas & Filtros.
- **Subscrito e Sobrescrito em um Relance:** Se subscrito, sobrescrito e tachado forem seus formatos ideais, adicione-os à sua faixa de opções e à Barra de Ferramentas de Acesso Rápido para acessá-los com facilidade.

### <a name="powerpoint-feature-updates"></a>PowerPoint: Atualizações de recursos

- **Chame a atenção das pessoas com \@Menções:** Use @menções nos comentários para que outras pessoas saibam quando você precisar da contribuição delas.
- **Os Vídeos Online Têm um Novo Lar:** Salve um vídeo no Microsoft Stream para que qualquer pessoa em sua organização possa vê-lo. Insira o link de vídeo e desfrute de uma apresentação multimídia com uma fração do tamanho do arquivo.
- **Legendas e legendas ao vivo:** suas palavras são mostradas automaticamente como legendas, ou são traduzidas para outro idioma como legendas enquanto você faz a apresentação. Para obter melhores resultados, use microfone e fone de ouvido.

### <a name="outlook-feature-updates"></a>Outlook: Atualizações de recursos

- **Do Outlook para o OneNote em Apenas um Clique:** Com o clique de um botão, você pode salvar suas mensagens do Outlook e anotações de reuniões em um bloco de anotações do OneNote. Use-o como um arquivo ou como um local conveniente para guardar suas coisas.<br/><br/>


## <a name="may-2019-release"></a>Lançamento de maio de 2019      

**Data do lançamento:** 14 de maio de 2019 

*Versão 16.25 (Build 19051201)*
...
|:-----|:-----|:-----|:-----|
|Word  <br/><br/>|**Ver anexos de email:** anexos de email agora estão disponíveis na guia Compartilhado. |[CVE-2019-0953](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2019-0953): vulnerabilidade de execução remota de código do Microsoft Word<br/>|[Pacote de atualização do Word](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate//Microsoft_Word_16.25.19051201_Updater.pkg)<br/>|
|Excel<br/>|**Ver anexos de email:** anexos de email agora estão disponíveis na guia Compartilhado.<br/><br/>**Coautoria nas melhorias de mesclagem:** a coautoria melhorou a taxa de sucesso de mesclagem ao trabalhar com formatação condicional, estilos de célula, proteção de intervalo, exibição de linhas de grade e fórmula de consolidação para cortar/colar.|<br/>|[Pacote de atualização do Excel](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate//Microsoft_Excel_16.25.19051201_Updater.pkg)<br/>|
|PowerPoint<br/>|**Ver anexos de email:** anexos de email agora estão disponíveis na guia Compartilhado.<br/><br/>**Trabalhe mais rápido com novos atalhos:** atalhos de teclado para itens como cortar, avançar/recuar e promover/rebaixar item da lista.|<br/>|[Pacote de atualização do PowerPoint](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_PowerPoint_16.25.19051201_Updater.pkg)<br/>|
|Outlook  <br/>|**Saiba a disponibilidade dos seus contatos num relance:** ver informações de presença de seus contatos que estão no Teams dentro do Outlook. <br/><br/>**Veja os principais detalhes dos seus contatos:** selecione o nome de um contato em uma mensagem ou evento de calendário para ver sua foto, número de telefone, email, organograma e muito mais. [Saiba Mais](https://support.office.com/article/cf25962a-3a3e-47be-9181-afa2e1f84b07) <br/><br/> | |[Pacote de atualização do Outlook](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_Outlook_16.25.19051201_Updater.pkg) <br/>|
...
|**Application**|**Atualizações de recurso**|**Atualizações de segurança**|**Link para baixar o pacote de atualização**|
|:-----|:-----|:-----|:-----|
|Word  <br/>|**Novos Ícones de Aplicativos do Office:** ícones de aplicativo reprojetados para refletir as experiências simples, avançadas e inteligentes do Office. <br/><br/>**Início mais Rápido:** receba recomendações baseadas nas suas atividades e no que as pessoas ao seu redor estão trabalhando.<br/><br/>**Assista seus documentos ganharem vida:** insira gráficos animados em 3D para ver batidas de corações, órbita de planetas e a fúria do T-Rex na página. [Saiba mais](https://support.office.com/article/6f08009a-3da5-400d-a706-8e23f304cd72)<br/>|<br/><br/> |[Pacote de atualização do Word](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_Word_16.24.19041401_Updater.pkg) <br/>|
...
|**Application**|**Atualizações de recurso**|**Atualizações de segurança**|**Link para baixar o pacote de atualização**|
|:-----|:-----|:-----|:-----|
|Word  <br/>| **Chame a atenção com @menções:** use @menções nos comentários quando quiser informar aos colegas de trabalho que você precisa da contribuição deles. [Saiba mais](https://support.office.com/article/644bf689-31a0-4977-a4fb-afe01820c1fd)<br/><br/>**Edição de equações LaTeX:** o Word agora dá suporte à sintaxe matemática LaTeX para criar equações matemáticas. [Saiba Mais](https://support.office.com/article/2e00618d-b1fd-49d8-8cb4-8d17f25754f8) | |[Pacote de atualização do Word](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_Word_16.23.19030902_Updater.pkg) <br/>|
|Excel  <br/>|**Chame a atenção com @menções:** use @menções nos comentários quando quiser informar aos colegas de trabalho que você precisa da contribuição deles. [Saiba mais](https://support.office.com/article/644bf689-31a0-4977-a4fb-afe01820c1fd)  <br/><br/>**Saiba mais sobre seus dados:** O novo botão Ideias procura padrões em seus dados e os usa para criar sugestões inteligentes e personalizadas. [Saiba mais](https://support.office.com/article/3223aab8-f543-4fda-85ed-76bb0295ffc4) |  <br/>  |[Pacote de atualização do Excel](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate//Microsoft_Excel_16.23.19030902_Updater.pkg) <br/>|
...
|Outlook  <br/>|  <br/><br/>  ||[Pacote de atualização do Outlook](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_Outlook_16.23.19030902_Updater.pkg) <br/>|

## <a name="february-2019-release"></a>Lançamento de fevereiro de 2019

**Data do lançamento:** 26 de fevereiro de 2019
...
|**Application**|**Atualizações de recurso**|**Atualizações de segurança**|**Link para baixar o pacote de atualização**|
|:-----|:-----|:-----|:-----|
|Palavra  <br/>| **Esboço com seu Trackpad:** mova o dedo no trackpad e veja o traço à tinta deslizar na tela. [Saiba mais](https://support.office.com/article/6d76c674-7f4b-414d-b67f-b3ffef6ccf53) <br/><br/>**Torne suas Imagens Acessíveis:** quando você insere uma imagem, o Office sugere legendas ocultas que podem ser lidas por pessoas com deficiências visuais. | |[Pacote de atualização do Word](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_Word_16.22.19021100_Updater.pkg) <br/>|
...
|PowerPoint  <br/>| **Esboço com seu Trackpad:** mova o dedo no trackpad e veja o traço à tinta deslizar na tela. [Saiba mais](https://support.office.com/article/6d76c674-7f4b-414d-b67f-b3ffef6ccf53) <br/><br/>**Hiperlinks em cor vibrante:** os hiperlinks deixarem de ser somente azuis. Aplique as cores de fonte que desejar. [Saiba Mais](https://support.office.com/article/988ed94c-82e9-4e2c-96a1-7ffd2c382ce8) | <br/>|[Pacote de atualização do PowerPoint](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_PowerPoint_16.22.19021100_Updater.pkg) <br/>|
...
|Pacote do Office <br/>|**Alterar rapidamente a imagem selecionada da faixa de opções de diferentes fontes:** Alterar Imagem permitirá que usuários modifiquem sua imagem/gráfico para uma imagem de nosso recurso Imagem Online, biblioteca de ícones ou a área de transferência. <br/>|<br/> | |
 ...
 *Versão 16.21.0 (Build 19011700)*

 Esta versão oferece as seguintes atualizações:

|**Application**|**Atualizações de recurso**|**Atualizações de segurança**|**Link para baixar o pacote de atualização**|
|:-----|:-----|:-----|:-----|
|Word  <br/>| Corrigido um problema com a localização em chinês.<br/><br/>**Quebre a barreira idiomática:** traduza palavras, frases ou todo o documento para outro idioma com o Microsoft Translator. Faça isso na guia Revisar na faixa de opções.| |[Pacote de atualização do Word](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_Word_16.21.19011700_Updater.pkg) <br/>|
|Outlook  <br/>| Corrigido um problema com a localização em chinês.<br/><br/>**Otimize a sincronização baseada no status de energia e de rede:** agora o Outlook otimiza a sincronização para suas contas do Exchange quando o dispositivo estiver ligado na bateria e em uma rede limitada, como wi-fi no avião.<br/><br/>**Todos os detalhes da reunião em um relance:** clique no evento no seu calendário para ver todos os detalhes da reunião. Confira quem foi convidado, edite a resposta ou ingresse na reunião em um só lugar. [Saiba Mais](https://support.office.com/article/3b3b0575-36e2-4632-a982-1e6977870658)  | |[Pacote de atualização do Outlook](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_Outlook_16.21.19011700_Updater.pkg) <br/>|
 ...
 *Versão 16.21.0 (Build 190101500)* 
...
> [!NOTE]
> Nas ***novas*** instalações, o Microsoft Teams será instalado por padrão, começando pela versão 16.21. Para saber mais, confira o tópico [Instalações do Microsoft Teams no Mac](/DeployOffice/teams-install#microsoft-teams-installations-on-a-mac).  
...
|**Application**|**Atualizações de recurso**|**Atualizações de segurança**|**Link para baixar o pacote de atualização**|
|:-----|:-----|:-----|:-----|
|Word  <br/>| **Facilite sua visualização com o modo escuro:** um fundo escuro é mais fácil para os olhos em ambientes de pouca luz. Requer Mojave macOS. <br/><br/>  **Preservar a aparência do seu texto:** incorporar fontes para garantir que o texto do documento fique igual em todos os computadores. Sem mais surpresas! [Saiba mais](https://support.office.com/article/53046a60-0111-4ca4-bb58-26be3926a9d3) <br/><br/>**Visualizar fontes inseridas em documentos:** permite que fontes inseridas em um arquivo sejam renderizadas no Word para Mac.<br/><br/>**Barra de status invocável do modo de foco:** no modo de Foco, é mais fácil visualizar a contagem de palavras e acessar controles de zoom com a barra de status invocável.<br/><br/>**Faça mais com o Modo de Foco:** agora, o Modo de Foco abre ao definir o nível de zoom e também mostra o número da página ao rolar.| |[Pacote de atualização do Word](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_Word_16.20.18120801_Updater.pkg) <br/>|
...
|Pacote do Office  <br/>|**Os ícones da faixa de opções ganharam uma nova aparência:** não se preocupe, tudo funciona da mesma maneira. Além disso, todos os ícones têm uma aparência incrível em telas de todos os tamanhos. [Saiba Mais](https://support.office.com/article/a6cdf19a-b2bd-4be1-9515-d74a37aa59bf)<br/><br/>**Painel de texto Alt atualizado:** torne seu conteúdo mais acessível ao adicionar legendas úteis ou até marcar elementos como decorativos. |<br/>||


## <a name="november-2018-release"></a>Versão de novembro de 2018

 **Data do lançamento:** 13 de novembro de 2018 
  
 *Versão 16.19.0 (Build 18110915)* 
...
## <a name="october-2018-release"></a>Versão de outubro de 2018

 **Data da versão:** 16 de outubro de 2018 
  
 *Versão 16.18.0 (Build 18101400)* 
 ...
 **Data da versão:** 14 de agosto de 2018 
  
 *Versão 16.16.0 (Build 18081201)* 
...
## <a name="june-2018-release"></a>Lançamento de junho de 2018
...
**Data de lançamento:** 23 de maio de 2018

*Versão 16.13.1 (Build 18052203)* \*

Esta versão inclui uma notificação de usuário final em conformidade com a Regulamentação Geral de Proteção de Dados (RGPD).

\**O número do build do Outlook é 18052301.* 
...
|**Aplicativo**|**Atualizações de recursos**|**Atualizações de segurança**|**Link para baixar o pacote de atualização**|
|:-----|:-----|:-----|:-----|
|Word  <br/> |**Converse com coautores durante a edição:** colabore mais efetivamente conversando com seus coautores sem sair do Word. [Saiba mais](https://support.office.com/article/1ecc6c7f-0b02-4baa-b9d9-c9d67023bedd.aspx) <br/><br/> **Inserir e editar ícones:** use ícones para acrescentar impacto visual ao seu documento inserindo e editando um dos 500 ícones. [Saiba mais](https://support.office.com/article/e2459f17-3996-4795-996e-b9a13486fa79) <br/><br/> **Faça o seu melhor currículo ou CV com a ajuda do LinkedIn:** o Assistente de Currículos mostra suas experiências profissionais, principais qualificações e muito mais para uma determinada função. Encontre-o na guia Revisão. [Saiba mais](https://support.office.com/article/444ff6f0-ef74-4a9c-9091-ffd7a9d1917a.aspx)<br/> <br/> **Acessibilidade integrada:** use o teclado para acessar a faixa de opções rapidamente e formatar as palavras ou imagens inseridas.  <br/> |||
...
|PowerPoint  <br/> |**Melhor compartilhamento e colaboração:** suas apresentações do OneDrive sincronizadas localmente abrem diretamente na nuvem, o que permite que você salve automaticamente, compartilhe e colabore com facilidade.   <br/><br/> **Adicione impacto visual:** insira e edite Elementos Gráficos Vetoriais Escaláveis (SVGs) em suas apresentações para adicionar apelo visual e manter uma alta qualidade de imagem. [Saiba mais](https://support.office.com/article/69f29d39-194a-4072-8c35-dbe5e7ea528c#ID0EAAFAAA=Office_2016_on_Mac&ID0EAAEAAA=Office_2016_on_Mac) <br/> ||||
|Outlook  <br/> |**Adicione impacto visual:** insira e edite Elementos Gráficos Vetoriais Escaláveis (SVGs) em seus emails para adicionar apelo visual e manter uma alta qualidade de imagem. [Saiba mais](https://support.office.com/article/69f29d39-194a-4072-8c35-dbe5e7ea528c#ID0EAAFAAA=Office_2016_on_Mac&ID0EAAEAAA=Office_2016_on_Mac) <br/>  <br/>**Um calendário mais acionável:** clique em qualquer reunião ou evento no calendário para ver todos os detalhes associados. Confira quem está convidado, edite a resposta ou ingresse na reunião em um só lugar.  <br/> <br/> **Verificação mais fácil de resultados da pesquisa:** o Outlook realça o termo de pesquisa na lista de itens ou no painel de visualização.  <br/> <br/> **Números das semanas:** os números das semanas agora são exibidos no modo de exibição de mês do calendário e no minicalendário na barra lateral. Para permitir, marque "Mostrar números das semanas" no Outlook \> Preferências \> Calendário \> Opções de calendário.  <br/> <br/> **Agendamento de reuniões do Skype:** representantes agora podem agendar reuniões do Skype for Business Online em nome de entidades usando os endereços de email delas. *(Skype for Business apenas Online. Isso será habilitado para o Skype for Business Server 2015 em uma atualização futura do servidor.)*  <br/> ||Tratamento de erro aprimorado ao editar e excluir regras do servidor. Regras do servidor que contém erros agora são realçadas quando exibidas na lista de regras pela primeira vez.  <br/> ||
|OneNote  <br/> ||||
|Microsoft AutoUpdate 3.18  <br/> |Suporte para a ferramenta de linha de comando msupdate. [Saiba mais](/DeployOffice/mac/update-office-for-mac-using-msupdate) <br/> ||||
...
|**Aplicativo**|**Atualizações de recursos**|**Atualizações de segurança**|**Atualizações que não são de segurança**|
|:-----|:-----|:-----|:-----|:-----|
|Word  <br/> |**Faça mais com o Modo de foco:** o Modo de foco agora abre no nível de definição de zoom e mostra o número da página ao rolar.  <br/> ||||
|Excel  <br/> ||[CVE-2018-0907](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2018-0907): bypass de Recursos de Segurança do Microsoft Office Excel  <br/> |||
|PowerPoint  <br/> |**Fontes incorporadas:** fontes incorporadas garantem que sua apresentação tenha a mesma aparência em todos os computadores e as pessoas experimentem seu conteúdo como você planejou.  <br/> ||||
|Outlook  <br/> |**Tabelas:** insira tabelas em suas mensagens e eventos do calendário e leve estrutura ao seu conteúdo. Não é mais preciso copiar e colar de outros aplicativos do Office. [Saiba mais](https://support.office.com/article/cb35806b-4174-41d2-9cba-b6b624d988b3)  <br/><br/> **Exibir dois fusos horários simultaneamente:** quer saber que horas são em outra parte do mundo? Agora você pode adicionar um segundo fuso horário ao Outlook.  <br/><br/> **Programe entre fusos horários:** está viajando entre fusos horários? Crie um evento com início e fim em diferentes fusos horários e o Outlook cuidará da conversão.   <br/><br/> **Alterar o tamanho do texto:** aumente ou diminua o tamanho da fonte na barra lateral, na lista de mensagens e no painel de leitura. [Saiba mais](https://support.office.com/article/b225d877-1449-4757-9ee7-120d1c5da6b4) <br/> ||Corrigir um problema no qual o fuso horário padrão de seu computador observa o horário de verão e o modo de exibição Semana estiver selecionado, você veria todos os eventos alterados em uma hora na grade do calendário na semana inicial do horário de verão.  <br/> |
|Pacote do Office  <br/> ||[CVE-2018-0919](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2018-0919): vulnerabilidade de divulgação não autorizada de informações do Microsoft Office  <br/> |

   
## <a name="february-2018-release"></a>Lançamento de fevereiro de 2018
...
|:-----|:-----|:-----|
|Excel  <br/> |**Seleção de precisão:** já selecionou células demais ou as células erradas? Agora você pode desmarcar células indesejadas sem precisar recomeçar. [Saiba mais](https://support.office.com/article/d1b56f30-7d63-4a64-8f0b-da4958204b52) <br/> <br/> **Organize os dados da tabela:** você adorava a segmentação de dados nas Tabelas Dinâmicas. Agora você pode usá-la também em tabelas para ver exatamente quais filtros foram aplicados. [Saiba mais](https://support.office.com/article/249f966b-a9d5-4b0f-b31a-12651785d29d?#officeversion=mac) |
|PowerPoint  <br/> |**Foque no que é importante:** pegue o novo marca-texto para sinalizar informações importantes. [Saiba mais](https://support.office.com/article/28623777-d955-4fcf-bbc5-a50051552219#OperatingSystem=Mac&OfficeVersion=Mac) |
|Microsoft AutoUpdate 3.16  <br/> ||Corrige um problema com o failover do UpdateCache para a Rede de Distribuição de Conteúdo (CDN) do Office. |
   
## <a name="january-2018-release"></a>Versão de janeiro de 2018
...
## <a name="december-2017-release"></a>Versão de dezembro de 2017


 **Data de lançamento:** 17 de dezembro de 2017 
  
 Esta versão corrige um problema com o Microsoft AutoUpdate que oferecia uma atualização incorreta da versão. 
...
|**Aplicativo**|**Atualizações de segurança**|
|:-----|:-----|
|PowerPoint  <br/> |[CVE-2017-11934](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2017-11934): vulnerabilidade de divulgação não autorizada de informações do Microsoft PowerPoint |

   
## <a name="november-2017-release"></a>Versão de novembro de 2017
...
|**Aplicativo**|**Atualizações de segurança**|
|:-----|:-----|
|Word  <br/> |[Supervisão 170020](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/ADV170020): atualização de proteção abrangente do Microsoft Office  |
|Excel  <br/> |[CVE-2017-11877](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2017-11877): vulnerabilidade de bypass do recurso de segurança do Microsoft Excel  |
...
|PowerPoint  <br/> |**Editor do Visual Basic aprimorado:** crie e edite macros no Editor do Visual Basic usando o IntelliSense, menus VBA e barras de ferramentas, ferramentas de depuração, um pesquisador de objetos e muito mais.  |
|Outlook  <br/> |**Capacidade de leitura aprimorada e acessível também:** sua mensagem de email e os cabeçalhos de convite de reunião agora estão mais agradáveis aos olhos. Menos bagunça, melhor navegação no teclado e VoiceOver aprimorado.   |
|Pacote do Office  <br/> ||[CVE-2017-11825](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2017-11825): Vulnerabilidade de execução remota de código do Microsoft Office  |

   
## <a name="september-2017-release"></a>Versão de setembro de 2017
...
|Microsoft AutoUpdate 3.9.3  <br/> |Avisa os usuários para reinstalar o Microsoft AutoUpdate quando componentes ausentes ou defeituosos são detectados. |
   
## <a name="august-2017-release"></a>Versão de agosto de 2017
...
|PowerPoint  <br/> |**Links seguros:** Quando um usuário clica em um link, a Office 365 Advanced Threat Protection (ATP, Proteção Avançada contra Ameaças) inspeciona o link para ver se é mal-intencionado. Se o link for considerado mal-intencionado, o usuário será redirecionado para uma página de aviso em vez da URL de destino original. [Saiba mais](https://support.office.com/article/dd6a1fef-ec4a-4cf4-a25a-bb591c5811e3)  |

   
## <a name="july-2017-release"></a>Versão de julho de 2017
...
|Pacote do Office  <br/> ||[CVE-2017-8501](https://portal.msrc.microsoft.com/pt-BR/security-guidance/advisory/CVE-2017-8501): vulnerabilidade de corrupção de memória do Microsoft Office |
...
## <a name="may-2017-release"></a>Versão de maio de 2017
...
|Excel  <br/> |**Fonte Dubai:** família de fontes compatível com idiomas da Europa Ocidental e com a maioria dos idiomas que usam escrita árabe. [Saiba mais](https://support.office.com/article/c862df16-ae0d-46d9-b117-aa3f41f9706e.aspx) |
 ...
 **Data do lançamento:** 9 de maio de 2017 
  
Esta versão oferece as seguintes atualizações.
  
|**Aplicativo**|**Atualizações que não são de segurança**|
|:-----|:-----|
|Microsoft AutoUpdate 3.9.1  <br/> | – Corrigir um problema crítico que impedia que as notificações de atualização automática quando "Verificar automaticamente" estiver selecionado.  <br/><br/>  – Corrigir um problema em que o AutoUpdate trava no OS X 10.10.  <br/><br/> – Corrigir um problema em que os aplicativos não iniciavam se houver uma atualização pendente.   <br/><br/> **Importante:** se você atualizou para o Microsoft AutoUpdate 3.9.0 e tiver as configurações do AutoUpdate definidas como "Verificar automaticamente", será preciso atualizar manualmente para o Microsoft AutoUpdate 3.9.1 usando um dos seguintes métodos:  <br/><br/>  – Acesse **Ajuda** > **Verificar atualizações** e escolha **Verificar atualizações**.  <br/><br/>  – Acesse **Ajuda** > **Verificar atualizações** e, em seguida, selecione **Baixar e Instalar Automaticamente**.  |
   
## <a name="april-2017-release"></a>Versão de abril de 2017
...
|**Aplicativo**|**Atualizações de recurso**|**Atualizações de segurança**|
|:-----|:-----|:-----|
|Excel  <br/> ||Boletim de Segurança da Microsoft [MS17-014](/security-updates/SecurityBulletins/2017/ms17-014): Atualização de Segurança do Microsoft Office (3217868)   |
...
|Pacote do Office  <br/> ||Boletim de Segurança da Microsoft [MS17-014](/security-updates/SecurityBulletins/2017/ms17-014): Atualização de Segurança do Microsoft Office (3217868)  |
...
|PowerPoint  <br/> |**Suporte para Touch Bar:** os comandos mais relevantes para o seu trabalho ao seu alcance. (Compatível apenas com MacBook Pro com Touch Bar.)   |
|Microsoft AutoUpdate  <br/> ||Número da versão atualizado para 3.8.4. |
