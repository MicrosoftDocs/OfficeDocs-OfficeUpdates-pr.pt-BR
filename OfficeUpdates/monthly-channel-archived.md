...
ms.locfileid: "52026356"
---
# <a name="archived-release-notes-for-monthly-channel"></a>Notas de versão para lançamentos do Canal Mensal arquivadas
Estas notas de versão fornecem informações sobre novos recursos e atualizações não relacionados à segurança incluídos nas atualizações do Canal Mensal para o Office 365 ProPlus, o Visio Pro para Office 365, o Cliente de Área de Trabalho do Microsoft Project Online e o Office 365 Business.
...
>- O Microsoft Teams em instalações existentes do Office 365 ProPlus - A partir do início de julho, o Microsoft Teams será incluído nas atualizações do Office 365 ProPlus (e do Office 365 Business).  A data em que o Teams será adicionado depende de qual canal de atualização você está usando. Confira [Implantar o Microsoft Teams com o Office 365 ProPlus](/deployoffice/teams-install) para obter informações adicionais.


[//]: # (NÃO REMOVER O FIM DO CONTEÚDO BUGDETAILS)

## <a name="version-2011-december-21"></a>Versão 2011: 21 de dezembro
*Versão 2011 (Compilação 13426.20404)*
...
- O Pacote Office corrigiu um problema em que a instalação de uma versão mais recente do Office em relação a certas versões mais antigas pode resultar em funcionalidade prejudicada (como a impossibilidade de usar o Power Query) devido à falta de entradas de registro.
...
- **Atualizações da Experiência do Usuário para Tarefas:** uma atualização visual dos itens da tarefa.
...
- Corrigimos um problema que fazia com que o campo Para ficasse em branco ao enviar um relatório de progresso em uma tarefa.
...
## <a name="version-2010-november-17"></a>Versão 2010: 17 de novembro
*Versão 2010 (Build 13328.20408)*
...
- Corrigimos um problema que fazia com que os usuários ao experimentarem o aplicativo e ele encerrasse inesperadamente ao selecionar um resultado de pesquisa. 
...
## <a name="version-2009-september-28"></a>Versão 2009: 28 de setembro
...
- **Pesquisa de Arquivo Morto Online de Expansão Automática:** Habilitar a Pesquisa de Arquivo Morto Online de expansão automática

- **Novo cartão de perfil do Outlook:** Novo cartão de perfil do Outlook, incluindo uma melhor exibição da Organização e corresponde ao estilo de cartão do Outlook Web.
...
- Corrige um problema que provocou o envio de emails gerados automaticamente com um corpo em branco quando a linha de assunto fica em branco.
...
- Essa alteração corrige um problema com o recurso Exportar para GIF Animado em que clicar no botão Exportar não exporta.
...
## <a name="version-2007-july-30"></a>Versão 2007: 30 de julho
...
- **Novas configurações de notificação simplificadas:** Os usuários agora podem gerenciar suas configurações de notificações de uma maneira mais simplificada com funcionalidades aprimoradas.

- **As notificações nativas do Windows agora têm suporte no Teams:** Os usuários agora podem selecionar seus meios preferenciais de entrega de notificação, por meio de faixas compiladas no Teams ou faixas nativas do Windows.

- **Painel de Informações do Canal:** Ao selecionar o ícone "Informações do Canal" no cabeçalho do canal, um painel será aberto onde você verá um resumo de informações do canal, incluindo a descrição do canal, uma lista de colaboradores e membros recentes, bem como a nova página inicial das mensagens do sistema.

- **Desativar as visualizações prévias das suas notificações de chat:** Os usuários podem alterar as configurações e gerenciar as visualizações prévias de suas notificações de sistema do chat.

- **Respostas sugeridas:** Adicionamos a capacidade dos usuários do Teams a terem uma resposta sugerida para suas conversas. Essas sugestões serão exibidas abaixo de uma mensagem de bate-papo se estiverem habilitadas. Elas criam uma resposta rápida e fácil às mensagens!
...
- Corrigimos um problema no qual um erro ou falha poderia ocorrer ao se carregar uma pasta de trabalho com diversas planilhas no modo de visualização com quebra de página.
...
## <a name="version-2006-july-28"></a>Versão 2006: 28 de julho
*Versão 2006 (Compilação 13001.20498)*
...
- Um problema momentâneo poderia causar uma falha ao se fechar arquivos do Office.
...
- **Os números de telefone de participantes da PSTN estão mascarados de usuários externos:** Para clientes com conferências de áudio habilitadas para suas reuniões de equipe, vamos mascarar o número de telefone do participante PSTN para os usuários que ingressaram de fora da sua organização.

- **Maneira simplificada de gerenciar as configurações de notificação de canal:** Na lista equipes e canais ou no cabeçalho do canal, os usuários podem gerenciar rapidamente as configurações de notificação, ativando ou desativando todas as atividades com um único clique ou mergulhando profundamente no personalizado para definir suas permutações preferenciais.
...
- Solucionamos um problema que fazia com que Ctrl+clique parasse de funcionar quando as configurações de nuvem estavam habilitadas.
...
- Esse problema foi corrigido. Você deve ser capaz de chamar o tipo de dados Data/Hora Estendida para seu código sem falha no seu aplicativo. Deixe a equipe saber se você tiver problemas futuros.


- Esse problema foi corrigido. Agora você pode reverter para a versão mais atualizada do Access e usar o DAO/VBA para gerenciar e editar um tipo de dados decimal. Deixe a equipe do Access saber se você encontrar mais problemas com o uso do nosso tipo de dados.
...
- Solucionamos um problema que fazia com que os usuários vejam a mensagem &quot;As regras neste computador não correspondem às regras no Microsoft Exchange&quot; ao atualizar suas regras no Outlook.
...
## <a name="version-2005-june-02"></a>Versão 2005: 02 de junho
...
- **Não é preciso dar um clique: seus fones de ouvido fazem isso por você** Use seu Fones de Ouvido Surface para controlar suas apresentações de PowerPoint. Como funciona: uma vez emparelhada, você precisará habilitar o recurso no PowerPoint. Para iniciar uma apresentação, pressione F5 ou selecione Apresentação de Slides > Do Começo.  Na apresentação de slides, clique com o botão direito do mouse no slide e, em Configurações de Fones de Ouvido Surface, escolha usar Gestos para Controlar a Apresentação.  Essa configuração será lembrada por todas as apresentações futuras. Agora você pode passar o dedo para a frente e para trás no fone de ouvido esquerdo para navegar pelas apresentações no modo de apresentação de slides.  Dê um toque duplo para reproduzir ou pausar vídeos inseridos.  Importante: Você deve parear seu Surface Earbuds com o aplicativo Surface Audio para Windows 10 para usar gestos para controlar as apresentações. As instruções sobre como começar a usar o aplicativo de áudio Surface no Windows 10 estão disponíveis aqui. [Saiba mais](https://support.office.com/article/6319a6f3-ad69-44e6-a8ff-e79676423e4a)

### <a name="teams"></a>Teams

- **Alterações no layout de vídeo em reuniões do Teams:** Em breve, o número de participantes que podem ser visualizados simultaneamente durante uma reunião de equipe aumentará de 4 a 9.

- **Inclua áudio do sistema em eventos vivos:** Apresentadores e produtores em eventos vivos agora podem incluir áudio do sistema ao compartilhar uma tela da área de trabalho ou janela durante o evento ao vivo. Isso permitirá que os usuários ouçam o conteúdo que você está compartilhando.
...
- **Levantar a Mão nas Reuniões:** Os usuários agora podem levantar uma mão virtual em uma reunião! Os outros participantes verão a sua mão levantada ao lado do seu nome no estágio da reunião e ao lado do seu nome na lista.

- **Personalizar os planos de fundo de vídeo da reunião:** Ao acompanhar o vídeo, agora você tem a opção de imagens de tela de fundo estáticas diferentes para usar. Isso permitirá mostrar essa imagem e não o plano de fundo real de onde você está sentado.

- **Adicionar mais pessoas ao chat:** Já tornamos possível adicionar até 350 pessoas a um único encadeamento de chat.

- **Engrenagem de configurações no feed de atividades:** Os usuários agora podem acessar diretamente a configuração de feed de atividades e notificação do trilho para a esquerda por meio de um engrenagem de configurações.

- **Acesse facilmente as opções de reunião de dentro de uma reunião de equipe em andamento:** Estamos facilitando o acesso de organizadores e configurações de lobby rapidamente a seus apresentadores, uma vez que uma reunião de equipe começa, fornecendo um link fácil de acessar diretamente no painel de participantes. Essa nova funcionalidade estará presente para reuniões agendadas e em reuniões "Reunir Agora".

- **Análise de canal e equipe:** Além da análise do time, agora você também pode exibir métricas e ideias no nível de canal. Também melhoramos o período de tempo em 90 dias para que você possa analisar dados por períodos mais longos. Além disso, esta versão também inclui novas métricas e gráficos ao redor da contagem de postagens, respostas e reuniões para uma equipe ou canal.

- **Comunicados de entrada/saída:** Adicionamos esse recurso que permite aos organizadores de reunião ter a capacidade de ativar ou desativar os comunicados de entrada e saída para uma reunião.

### <a name="word"></a>Word

- **Decodificar degraus sem sair do Word:** Quando encontrar um acrônimo, o Word tentará defini-lo de acordo com a maneira como outras pessoas o usam.
...
- Correção de um problema Clique para Executar, o que resulta em falhas ocasionais de atualização para as versões mais recentes.

- Correção de um problema no Microsoft Office em que os projetos do Visual Basic for Applications com referências esperadas sejam encontrados, pesquisando localizações especificadas na variável de ambiente PATH podem não ser encontradas corretamente em tempo de execução, levando a erros de tempo de execução VBA.
...
- **Vincular ao Slide:** Peça a um colega para contribuir com o conjunto de slides e inicie-o diretamente no slide para o qual você precisa de ajuda.
...
- **Estatísticas da pasta de trabalho:** Células, fórmulas, gráficos, tabelas ... Nós os contamos para que você não precise fazer isso.
...
## <a name="version-1910-november-12"></a>Versão 1910: 12 de novembro
*Versão 1910 (Build 12130.20344)*
...
- **Instalar o Microsoft Teams em instalações existentes do Office 365 ProPlus:** a partir do final de Junho, o Microsoft Teams será incluído nas atualizações de instalações existentes do Office 365 ProPlus (e do Office 365 Business). A data em que o Teams será adicionado depende de qual canal de atualização você está usando. Confira, Implantar o Microsoft Teams com o Office 365 ProPlus para obter informações adicionais. [Saiba Mais](/deployoffice/teams-install)
...
- Para proteger a segurança dos clientes do Office, as atualizações do Microsoft Office agora são assinadas usando o algoritmo SHA-2 exclusivamente.<br>
...
- Corrigido um problema com a lógica de bloqueio de anexos no Outlook para também bloquear anexos do Python.
...
- **Repe-tinta-ção instantânea:** anime um desenho à tinta para que ele avance ou retroceda durante a sua apresentação de slides. [Saiba mais](https://support.office.com/article/fa4f044f-810b-43fe-b774-da04a0b37496)
...
- **Unir tabelas em colunas similares:** Obter e Transformar (Power Query) agora apresenta lógica de texto correspondente aproximado (também chamada de correspondência difusa) ao comparar colunas para mesclar tabelas. [Saiba mais](https://support.office.com/article/ffdd5082-c0c8-4c8e-a794-bd3962b90649)
...
## <a name="version-1906-july-09"></a>Versão 1906: 09 de julho
*Versão 1906 (Build 11727.20244)*
...
- Permita a transferência de arquivos para clientes do Office Communicator herdados de um computador com Windows 10 com vários adaptadores de rede.
...
## <a name="version-1901-january-31"></a>Versão 1901: 31 de janeiro
*Versão 1901, (build 11231.20130)* 
...
Apenas atualizações não relacionadas à segurança, tratando de problemas de desempenho.
...
## <a name="version-1811-december-11"></a>Versão 1811: 11 de dezembro
*Versão 1811 (build 11029.20108)* 
...
*Versão 1809 (build 10827.20181)* 

### <a name="office-suite-non-security-updates"></a>Pacote do Office: atualizações não relacionadas à segurança 
-  Correção de vários problemas de desempenho.


## <a name="version-1809-october-9"></a>Versão 1809: 9 de outubro
*Versão 1809 (build 10827.20150)*
...
## <a name="version-1809-september-27"></a>Versão 1809: 27 de setembro
...
- **Dê uma forma incrível ao seu documento** Transforme seu documento em uma página da web interativa e fácil de compartilhar, com uma aparência ótima em qualquer dispositivo.  [Saiba mais](https://support.office.com/article/65912b2d-8b81-41e1-ac52-c20a65ce8ecf)
...
### <a name="outlook-non-security-updates"></a>Outlook: atualizações não relacionadas à segurança
 - Corrige um problema que fazia com que o link "Clique para ver mais ..." ficasse ausente na lista de resultados da pesquisa para alguns usuários com várias contas do Exchange configuradas.

### <a name="office-suite-non-security-updates"></a>Pacote do Office: atualizações não relacionadas à segurança
 - Correção de um problema que causava a demora na instalação de atualização em determinadas situações.
 
### <a name="lync-non-security-updates"></a>Lync: Atualizações que não são de segurança
 - Corrige um problema que impedia que emoticons em mensagens de mensagens Instantâneas fossem exibidos. 


## <a name="version-1807-august-14"></a>Versão 1807: 14 de agosto
*Versão 1807 (build 10325.20118)*
...
## <a name="version-1806-july-17"></a>Versão 1806: 17 de julho
*Versão 1806 (build 10228.20134)*
...
## <a name="version-1805-may-23"></a>Versão 1805: 23 de maio
*Versão 1805 (build 9330.2078)*
...
### <a name="outlook-feature-updates"></a>Outlook: atualizações de recursos
 ...
 - **Veja 3 fusos horários:** precisa agendar uma reunião em diferentes fusos horários? Adicione vários fusos ao seu calendário para ver facilmente a disponibilidade dos participantes e escolha um horário que funcione para todos. [Saiba mais](https://support.office.com/article/5ab3e10e-5a6c-46af-ab48-156fedf70c04)
 - **Compartilhamento de calendário facilitado:** compartilhar seus calendários está mais simples e agora os calendários compartilhados com o Outlook para área de trabalho também estão disponíveis no Outlook Mobile. [Saiba mais](https://support.office.com/article/353ed2c1-3ec5-449d-8c73-6931a0adab88)

### <a name="outlook-non-security-updates"></a>Outlook: atualizações não relacionadas à segurança
- Altere as palavras em um convite para compartilhar um calendário de "Abrir este calendário" para "Aceitar".
...
### <a name="word-feature-updates"></a>Word: atualizações de recursos
 - **Converse com coautores durante a edição:** colabore mais efetivamente conversando com seus coautores sem sair do Word. [Saiba mais](https://support.office.com/article/1ecc6c7f-0b02-4baa-b9d9-c9d67023bedd)
 - **Digitação sem mãos:** use sua voz para criar documentos simplesmente ditando. Não é preciso digitar. [Saiba mais](https://support.office.com/article/d4fd296e-8f15-4168-afec-1f95b13a6408)
...
## <a name="version-1804-may-14"></a>Versão 1804: 14 de maio
*Versão 1804 (build 9226.2156)*
...
## <a name="version-1804-april-25"></a>Versão 1804: 25 de abril
*Versão 1804 (build 9226.2114)*
...
### <a name="word-feature-updates"></a>Word: atualizações de recursos
-   **Localizar e corrigir problemas relevantes de revisão de texto:** agora o painel do Editor exibe uma visão geral dos problemas de revisão de texto encontrados no documento, assim o foco fica na correção daqueles que são relevantes para você.
...
### <a name="outlook-feature-updates"></a>Outlook: atualizações de recursos
-   **Aviso de cópia oculta (cco):** um aviso será exibido se você escolher Responder a Todos em uma mensagem na qual você estava em cópia oculta.
-   **Uma linha Para: mais inteligente:** ao clicar na linha Para: para endereçar a mensagem, sugerimos os destinatários com mais chances de serem escolhidos. Além disso, você verá a imagem do destinatário, para saber que está enviando para a pessoa certa. 
...
## <a name="version-1802-february-26"></a>Versão 1802: 26 de fevereiro
*Versão 1802 (build 9029.2167)*
...
## <a name="version-1801-february-1"></a>Versão 1801: 1 de fevereiro
*Versão 1801 (build 9001.2138)*
...
## <a name="version-1712-january-30"></a>Versão 1712: 30 de janeiro
*Versão 1712 (build 8827.2179)*
...
## <a name="version-1712-january-17"></a>Versão 1712: 17 de janeiro
*Versão 1712 (build 8827.2148)*
...
### <a name="visio-feature-updates"></a>Visio: atualizações de recursos
-   **Usar modelos do Excel para exportar para um diagrama do Visio:** Saia na frente em relação aos fluxogramas do Visio. Insira os dados em um dos modelos do Excel do Mapa de Processo e exporte para o Visio para criar o diagrama automaticamente. Requer o Visio Pro para Office 365.
...
## <a name="version-1711-january-2"></a>Versão 1711: 2 de janeiro
*Versão 1711 (build 8730.2165)*
