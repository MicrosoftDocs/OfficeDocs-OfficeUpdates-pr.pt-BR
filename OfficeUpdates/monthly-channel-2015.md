---
title: Notas de versão para versões do Canal Mensal em 2015
ms.author: anankani
author: andymosten
manager: anankani
ms.date: 12/11/2015
...
description: Fornece notas de versão aos profissionais de IT para versões do Canal Mensal para o Office 365 ProPlus em 2015
ms.openlocfilehash: 21afefcf714dcdd67d193b74b2e9f7d69f64c0c9
ms.sourcegitcommit: 04f3aa30703f4f1cf89721853a7c052fcca2b97f
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 03/24/2021
ms.locfileid: "51169880"
---
# <a name="release-notes-for-monthly-channel-releases-in-2015"></a>Notas de versão para versões do Canal Mensal em 2015

Essas notas de versão fornecem informações sobre novos recursos, atualizações de segurança e atualizações que não são de segurança incluídas nas atualizações do Canal Mensal para o Office 365 ProPlus em 2015.
...
-   **Modelos de BI:** Três novos modelos que aproveitam os recursos de business intelligence (BI) do Excel: [Insights do Calendário,](https://support.office.com/article/7edbeb88-99ca-403f-a394-7e957d3d3f40)Análise [de](https://support.office.com/article/f65e62ac-7af6-4cc6-98f3-f68b147ed65d)Ações, Meu Fluxo [de Caixa](https://support.office.com/article/215e9e2e-5813-41ad-a9ef-a0c0874841bb)
...
-   **Inserir API de Imagem**: insira imagens no Word, no Excel ou no PowerPoint usando o [método document.setSelectedDataAsync](/javascript/api/office/office.document) na biblioteca comum do office.js. A API JavaScript do Word fornece métodos específicos do host chamados insertInlinePictureFromBase64() para definir imagens em linha nos objetos [Body,](/office/dev/add-ins/reference/overview/word-add-ins-reference-overview) [ContentControl,](/javascript/api/word/word.contentcontrol) [Paragraph](/javascript/api/word/word.paragraph)e Range.
